# KEP-4 Milestone M8 Authorization Packet — Common Symptoms & General Laboratory Tests

## Executive Summary
- **Milestone ID**: M8
- **Package ID**: `KEP4-PACKAGE-M8-COMMON-SYMPTOMS-LABS-001`
- **Generated At**: `2026-08-08T05:34:40.696Z`
...
- **`L0004` (crp)**: lab-test upgraded to `v1.1.0` bound to citation `CIT-0004`
- **`L0015` (fasting-blood-sugar)**: lab-test upgraded to `v1.1.0` bound to citation `CIT-0070`
- **`L0005` (hba1c)**: lab-test upgraded to `v1.1.0` bound to citation `CIT-0070`
- **`L0012` (lft)**: lab-test upgraded to `v1.1.0` bound to citation `CIT-0004`
- **`L0002` (tsh)**: lab-test upgraded to `v1.1.0` bound to citation `CIT-0068`
- **`L0035` (ft3)**: lab-test upgraded to `v1.1.0` bound to citation `CIT-0068`
- **`L0036` (ft4)**: lab-test upgraded to `v1.1.0` bound to citation `CIT-0068`

## Governance & Relationship Proposals
- **Governed Draft Proposals**: 95
- **Draft Only**: Yes
- **RAG Ineligible**: Yes
...
## Verification Hashes
- **Package SHA-256**: `a1d4ef47541128aed4416061fd146c4c9562c331c403774418fb491efd44329e`
