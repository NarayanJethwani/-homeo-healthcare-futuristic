...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **KI-003** | Satellite node animations occasionally lag on low-end mobile devices | 2026-07-08 | UI/Clinical | Low | Issue logged during sprint deployment. | Resolved |
...
| **KI-002** | Satellite node animation performance lag | 2026-07-08 | UI | Medium | Graph satellite nodes may stutter on low-performance mobile devices; plan to throttle canvas refresh rates. | Active |
