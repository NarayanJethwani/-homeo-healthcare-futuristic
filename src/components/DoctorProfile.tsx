...
export default function DoctorProfile() {
  const credentials = [
    {
      year: "1999",
      title: "BHMS Graduate",
      institution: "Pioneered in classical homeopathic medicine and surgery.",
      icon: <GraduationCap className="w-4 h-4 text-mint" />,
    },
    {
      year: "2005",
      title: "Clinical Research Director",
      institution: "Founded the Advanced Clinical Research Centre for Chronic Auto-Immune Disorders.",
      icon: <Briefcase className="w-4 h-4 text-aqua" />,
    },
    {
      year: "2012",
      title: "Constitutional Specialist",
      institution: "Residency in Constitutional Medicine and Genetics mapping (London, UK).",
      icon: <Award className="w-4 h-4 text-lavender" />,
    },
    {
      year: "2019",
      title: "Global Telehealth Network",
      institution: "Launched virtual consultation systems serving patients in over 30 countries.",
  ...
  const testimonials = [
    {
      quote: "My chronic eczema, which had resisted conventional steroid therapies for 6 years, cleared within 4 months of Dr. Jethwani's constitutional treatment. Absolutely life-changing.",
    ...
    {
      quote: "The personalized remedy healed my stress-induced IBS completely. Dr. Jethwani is exceptionally intelligent and empathetic. He targets the true root causes of disease.",
      author: "Rahul Mehta",
      location: "Mumbai, IN",
      yOffset: [0, 10, 0],
      duration: 8,
    ...
    {
      quote: "His treatment for my son's chronic asthma was gentle, sweet, and highly effective. In less than 3 months, his inhaler dependency vanished completely.",
      author: "Anna Linden",
      location: "Berlin, DE",
      yOffset: [0, -8, 0],
      duration: 7,
