import { RecoveryMetric, DiseaseDistribution } from "../domain/analytics";

/**
 * Service to fetch data for recovery trends and disease spreads
 */
export function getMockRecoveryTrends(): RecoveryMetric[] {
  return [
...
export function getMockDiseaseDistribution(): DiseaseDistribution[] {
  return [
