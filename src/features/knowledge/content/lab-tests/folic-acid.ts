...
export const FolicAcidLabTest: KnowledgeEntity = {
  id: "L0040",
  slug: "folic-acid",
  entityType: "lab-test",
  ...
  summary: {
    en: "Clinical purpose, normal range, and interpretation of Folic Acid lab results.",
    hi: "Folic Acid प्रयोगशाला परीक्षण विवरण.",
    gu: "Folic Acid લેબોરેટરી ટેસ્ટ પરિચય.",
    mr: "Folic Acid लॅब टेस्ट माहिती.",
    es: "Propósito e interpretación de la prueba de laboratorio Folic Acid.",
    ar: "الغرض السريري وتفسير نتائج اختبار Folic Acid."
  },
  content: {
  "overview": "FOLIC ACID: A blood panel parameter or cell count analysis designed to evaluate red cell mass, immune defense lines, and coagulation potential.",
  ...
  "clinicalInterpretation": "FOLIC ACID evaluation: Red cell and hemoglobin drops suggest anemia, necessitating iron, B12, or folate evaluation. WBC spikes indicate infection or severe inflammation, while platelet drops warn of bleeding risks.",
  "references": [
    "CIT-0015",
    "CIT-0016",
    "CIT-0022"
  ...
  tags: ["Folic Acid", "Lab-Test", "Diagnostics"],
  canonicalUrl: "https://homeo.healthcare/knowledge/lab-tests/folic-acid",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Folic Acid test guidelines"]
};
