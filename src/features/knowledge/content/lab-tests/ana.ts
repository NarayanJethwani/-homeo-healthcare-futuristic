...
export const ANALabTest: KnowledgeEntity = {
  id: "L0026",
  slug: "ana",
  entityType: "lab-test",
  ...
  summary: {
    en: "Clinical purpose, normal range, and interpretation of ANA lab results.",
    hi: "ANA प्रयोगशाला परीक्षण विवरण.",
    gu: "ANA લેબોરેટરી ટેસ્ટ પરિચય.",
    mr: "ANA लॅब टेस्ट माहिती.",
    es: "Propósito e interpretación de la prueba de laboratorio ANA.",
    ar: "الغرض السريري وتفسير نتائج اختبار ANA."
  },
  content: {
  "overview": "ANA: A blood panel parameter or cell count analysis designed to evaluate red cell mass, immune defense lines, and coagulation potential.",
  ...
  "clinicalInterpretation": "ANA evaluation: Red cell and hemoglobin drops suggest anemia, necessitating iron, B12, or folate evaluation. WBC spikes indicate infection or severe inflammation, while platelet drops warn of bleeding risks.",
  "references": [
    "CIT-0015",
    "CIT-0016",
    "CIT-0022"
  ...
  tags: ["ANA", "Lab-Test", "Diagnostics"],
  canonicalUrl: "https://homeo.healthcare/knowledge/lab-tests/ana",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of ANA test guidelines"]
};
