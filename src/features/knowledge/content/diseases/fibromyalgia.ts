...
export const FibromyalgiaDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Fibromyalgia, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Fibromyalgia का नैदानिक विवरण.",
    gu: "Fibromyalgia નો તબીબી પરિચય.",
    mr: "Fibromyalgia चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Fibromyalgia.",
    ar: "نظرة عامة سريرية شاملة لـ Fibromyalgia."
  },
  content: {
    overview: "Fibromyalgia is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Fibromyalgia is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Fibromyalgia.",
  ...
  tags: ["Fibromyalgia", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/fibromyalgia",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Fibromyalgia profile"]
};
