...
export const GastroenteritisDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Gastroenteritis, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Gastroenteritis का नैदानिक विवरण.",
    gu: "Gastroenteritis નો તબીબી પરિચય.",
    mr: "Gastroenteritis चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Gastroenteritis.",
    ar: "نظرة عامة سريرية شاملة لـ Gastroenteritis."
  },
  content: {
    overview: "Gastroenteritis is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Gastroenteritis is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Gastroenteritis.",
  ...
  tags: ["Gastroenteritis", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/gastroenteritis",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Gastroenteritis profile"]
};
