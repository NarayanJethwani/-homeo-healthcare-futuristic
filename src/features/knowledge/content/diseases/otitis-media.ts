...
export const OtitisMediaDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Otitis Media, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Otitis Media का नैदानिक विवरण.",
    gu: "Otitis Media નો તબીબી પરિચય.",
    mr: "Otitis Media चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Otitis Media.",
    ar: "نظرة عامة سريرية شاملة لـ Otitis Media."
  },
  content: {
    overview: "Otitis Media is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Otitis Media is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Otitis Media.",
  ...
  tags: ["Otitis Media", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/otitis-media",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Otitis Media profile"]
};
