...
export const MenopauseDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Menopause, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Menopause का नैदानिक विवरण.",
    gu: "Menopause નો તબીબી પરિચય.",
    mr: "Menopause चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Menopause.",
    ar: "نظرة عامة سريرية شاملة لـ Menopause."
  },
  content: {
    overview: "Menopause is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Menopause is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Menopause.",
  ...
  tags: ["Menopause", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/menopause",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Menopause profile"]
};
