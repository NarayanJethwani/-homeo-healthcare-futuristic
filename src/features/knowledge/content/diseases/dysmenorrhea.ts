...
export const DysmenorrheaDisease: KnowledgeEntity = {
  ...
  content: {
  "overview": "Dysmenorrhea: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
