...
export const DysmenorrheaDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Dysmenorrhea, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Dysmenorrhea का नैदानिक विवरण.",
    gu: "Dysmenorrhea નો તબીબી પરિચય.",
    mr: "Dysmenorrhea चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Dysmenorrhea.",
    ar: "نظرة عامة سريرية شاملة لـ Dysmenorrhea."
  },
  content: {
    overview: "Dysmenorrhea is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Dysmenorrhea is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Dysmenorrhea.",
  ...
  tags: ["Dysmenorrhea", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/dysmenorrhea",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Dysmenorrhea profile"]
};
