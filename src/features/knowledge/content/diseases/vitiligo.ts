...
export const VitiligoDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Vitiligo, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Vitiligo का नैदानिक विवरण.",
    gu: "Vitiligo નો તબીબી પરિચય.",
    mr: "Vitiligo चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Vitiligo.",
    ar: "نظرة عامة سريرية شاملة لـ Vitiligo."
  },
  content: {
    overview: "Vitiligo is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Vitiligo is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Vitiligo.",
  ...
  tags: ["Vitiligo", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/vitiligo",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Vitiligo profile"]
};
