...
export const AcneVulgarisDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Acne Vulgaris, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Acne Vulgaris का नैदानिक विवरण.",
    gu: "Acne Vulgaris નો તબીબી પરિચય.",
    mr: "Acne Vulgaris चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Acne Vulgaris.",
    ar: "نظرة عامة سريرية شاملة لـ Acne Vulgaris."
  },
  content: {
    overview: "Acne Vulgaris is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Acne Vulgaris is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Acne Vulgaris.",
  ...
  tags: ["Acne Vulgaris", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/acne-vulgaris",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Acne Vulgaris profile"]
};
