...
export const HemorrhoidsDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Hemorrhoids, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Hemorrhoids का नैदानिक विवरण.",
    gu: "Hemorrhoids નો તબીબી પરિચય.",
    mr: "Hemorrhoids चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Hemorrhoids.",
    ar: "نظرة عامة سريرية شاملة لـ Hemorrhoids."
  },
  content: {
    overview: "Hemorrhoids is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Hemorrhoids is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Hemorrhoids.",
  ...
  tags: ["Hemorrhoids", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/hemorrhoids",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Hemorrhoids profile"]
};
