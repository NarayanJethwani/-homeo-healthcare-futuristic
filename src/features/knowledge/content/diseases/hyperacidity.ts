...
export const HyperacidityDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Hyperacidity, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Hyperacidity का नैदानिक विवरण.",
    gu: "Hyperacidity નો તબીબી પરિચય.",
    mr: "Hyperacidity चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Hyperacidity.",
    ar: "نظرة عامة سريرية شاملة لـ Hyperacidity."
  },
  content: {
  "overview": "Hyperacidity: Gastrointestinal and functional bowel disorders represent a high-prevalence clinical area involving dysmotility, altered acid secretion, and mucosal inflammation. Effective management relies on stabilizing motility and gut-brain signaling.",
  ...
  tags: ["Hyperacidity", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/hyperacidity",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Hyperacidity profile"]
};
