...
export const GingivitisDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Gingivitis, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Gingivitis का नैदानिक विवरण.",
    gu: "Gingivitis નો તબીબી પરિચય.",
    mr: "Gingivitis चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Gingivitis.",
    ar: "نظرة عامة سريرية شاملة لـ Gingivitis."
  },
  content: {
    overview: "Gingivitis is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Gingivitis is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Gingivitis.",
  ...
  tags: ["Gingivitis", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/gingivitis",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Gingivitis profile"]
};
