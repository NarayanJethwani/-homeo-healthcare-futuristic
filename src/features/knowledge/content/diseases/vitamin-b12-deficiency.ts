...
export const VitaminB12DeficiencyDisease: KnowledgeEntity = {
  ...
  aiReadiness: {
    ...
    clinicalSummary: "Start with serum or plasma B12 and a complete blood count. Consider MMA for borderline values or a discordant clinical picture, then investigate diet, medications, pernicious anaemia, and gastrointestinal malabsorption. Neurological symptoms need timely assessment. This information does not replace clinician-guided treatment or urgent assessment for red-flag symptoms.",
