...
export const VaricoseVeinsDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Varicose Veins, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Varicose Veins का नैदानिक विवरण.",
    gu: "Varicose Veins નો તબીબી પરિચય.",
    mr: "Varicose Veins चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Varicose Veins.",
    ar: "نظرة عامة سريرية شاملة لـ Varicose Veins."
  },
  content: {
    overview: "Varicose Veins is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Varicose Veins is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Varicose Veins.",
  ...
  tags: ["Varicose Veins", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/varicose-veins",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Varicose Veins profile"]
};
