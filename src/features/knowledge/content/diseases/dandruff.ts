...
export const DandruffDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Dandruff, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Dandruff का नैदानिक विवरण.",
    gu: "Dandruff નો તબીબી પરિચય.",
    mr: "Dandruff चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Dandruff.",
    ar: "نظرة عامة سريرية شاملة لـ Dandruff."
  },
  content: {
    overview: "Dandruff is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Dandruff is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Dandruff.",
  ...
  tags: ["Dandruff", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/dandruff",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Dandruff profile"]
};
