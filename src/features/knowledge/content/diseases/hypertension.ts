...
export const HypertensionDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Hypertension, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Hypertension का नैदानिक विवरण.",
    gu: "Hypertension નો તબીબી પરિચય.",
    mr: "Hypertension चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Hypertension.",
    ar: "نظرة عامة سريرية شاملة لـ Hypertension."
  },
  content: {
    overview: "Hypertension is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Hypertension is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Hypertension.",
  ...
  tags: ["Hypertension", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/hypertension",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Hypertension profile"]
};
