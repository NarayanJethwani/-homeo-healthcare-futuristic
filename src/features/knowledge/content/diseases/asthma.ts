...
export const AsthmaDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Asthma, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Asthma का नैदानिक विवरण.",
    gu: "Asthma નો તબીબી પરિચય.",
    mr: "Asthma चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Asthma.",
    ar: "نظرة عامة سريرية شاملة لـ Asthma."
  },
  content: {
    overview: "Asthma is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Asthma is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Asthma.",
  ...
  tags: ["Asthma", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/asthma",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Asthma profile"]
};
