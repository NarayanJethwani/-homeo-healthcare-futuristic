...
export const TrigeminalNeuralgiaDisease: KnowledgeEntity = {
  ...
  title: {
    ...
    hi: "Trigeminal Neuralgia",
    gu: "Trigeminal Neuralgia",
    mr: "Trigeminal Neuralgia",
    es: "Trigeminal Neuralgia",
    ar: "Trigeminal Neuralgia"
  },
  summary: {
    en: "A comprehensive clinical overview of Trigeminal Neuralgia, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Trigeminal Neuralgia का नैदानिक विवरण.",
    gu: "Trigeminal Neuralgia નો તબીબી પરિચય.",
    mr: "Trigeminal Neuralgia चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Trigeminal Neuralgia.",
    ar: "نظرة عامة سريرية شاملة لـ Trigeminal Neuralgia."
  },
  content: {
    overview: "Trigeminal Neuralgia is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Trigeminal Neuralgia is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Trigeminal Neuralgia.",
  ...
  tags: ["Trigeminal Neuralgia", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/trigeminal-neuralgia",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Trigeminal Neuralgia profile"]
};
