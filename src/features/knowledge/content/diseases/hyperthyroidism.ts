...
export const HyperthyroidismDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Hyperthyroidism, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Hyperthyroidism का नैदानिक विवरण.",
    gu: "Hyperthyroidism નો તબીબી પરિચય.",
    mr: "Hyperthyroidism चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Hyperthyroidism.",
  ...
  tags: ["Hyperthyroidism", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/hyperthyroidism",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Hyperthyroidism profile"]
};
