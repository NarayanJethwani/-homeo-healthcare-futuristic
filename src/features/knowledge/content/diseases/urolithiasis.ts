...
export const UrolithiasisDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Urolithiasis, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Urolithiasis का नैदानिक विवरण.",
    gu: "Urolithiasis નો તબીબી પરિચય.",
    mr: "Urolithiasis चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Urolithiasis.",
    ar: "نظرة عامة سريرية شاملة لـ Urolithiasis."
  },
  content: {
    overview: "Urolithiasis is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Urolithiasis is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Urolithiasis.",
  ...
  tags: ["Urolithiasis", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/urolithiasis",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Urolithiasis profile"]
};
