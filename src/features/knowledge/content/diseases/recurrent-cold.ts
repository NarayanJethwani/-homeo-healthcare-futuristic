...
export const RecurrentColdDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "Frequent colds are repeated viral infections of the nose and throat. Most improve with time, rest, fluids, and symptom relief; learn when repeated illness or breathing symptoms need medical advice.",
  ...
  content: {
    ...
    homeopathicApproach:
      "Reliable clinical evidence has not established homeopathy as a treatment that prevents or shortens colds. It should not replace rest, hydration, symptom relief, vaccines recommended for you, or medical assessment for concerning symptoms.",
    lifestyleAdvice:
  ...
  changeLog: ["1.1.0: Promoted to governed v1.1.0 with comprehensive viral URTI antigenic diversity clinical boundaries, bacterial pneumonia/quinsy red flags, and verified citations", "1.2.0: Simplified the patient-facing title and summary."],
