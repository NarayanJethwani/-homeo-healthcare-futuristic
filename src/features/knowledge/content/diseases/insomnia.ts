...
export const InsomniaDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Insomnia, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Insomnia का नैदानिक विवरण.",
    gu: "Insomnia નો તબીબી પરિચય.",
    mr: "Insomnia चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Insomnia.",
    ar: "نظرة عامة سريرية شاملة لـ Insomnia."
  },
  content: {
    overview: "Insomnia is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Insomnia is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Insomnia.",
  ...
  tags: ["Insomnia", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/insomnia",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Insomnia profile"]
};
