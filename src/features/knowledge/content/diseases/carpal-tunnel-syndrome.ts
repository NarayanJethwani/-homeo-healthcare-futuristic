...
export const CarpalTunnelSyndromeDisease: KnowledgeEntity = {
  ...
  title: {
    ...
    hi: "Carpal Tunnel Syndrome",
    gu: "Carpal Tunnel Syndrome",
    mr: "Carpal Tunnel Syndrome",
    es: "Carpal Tunnel Syndrome",
    ar: "Carpal Tunnel Syndrome"
  },
  summary: {
    en: "A comprehensive clinical overview of Carpal Tunnel Syndrome, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Carpal Tunnel Syndrome का नैदानिक विवरण.",
    gu: "Carpal Tunnel Syndrome નો તબીબી પરિચય.",
    mr: "Carpal Tunnel Syndrome चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Carpal Tunnel Syndrome.",
    ar: "نظرة عامة سريرية شاملة لـ Carpal Tunnel Syndrome."
  },
  content: {
    overview: "Carpal Tunnel Syndrome is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Carpal Tunnel Syndrome is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Carpal Tunnel Syndrome.",
  ...
  tags: ["Carpal Tunnel Syndrome", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/carpal-tunnel-syndrome",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Carpal Tunnel Syndrome profile"]
};
