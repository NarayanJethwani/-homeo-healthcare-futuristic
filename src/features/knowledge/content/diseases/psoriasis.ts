...
export const PsoriasisDisease: KnowledgeEntity = {
  ...
  content: {
    overview: "Psoriasis is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Psoriasis is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Psoriasis.",
