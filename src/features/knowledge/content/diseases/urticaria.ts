...
export const UrticariaDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Urticaria, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Urticaria का नैदानिक विवरण.",
    gu: "Urticaria નો તબીબી પરિચય.",
    mr: "Urticaria चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Urticaria.",
    ar: "نظرة عامة سريرية شاملة لـ Urticaria."
  },
  content: {
    overview: "Urticaria is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Urticaria is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Urticaria.",
  ...
  tags: ["Urticaria", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/urticaria",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Urticaria profile"]
};
