...
export const OsteoarthritisDisease: KnowledgeEntity = {
  ...
  summary: {
    en: "A comprehensive clinical overview of Osteoarthritis, covering causes, clinical symptoms, and homeopathic management principles.",
    hi: "Osteoarthritis का नैदानिक विवरण.",
    gu: "Osteoarthritis નો તબીબી પરિચય.",
    mr: "Osteoarthritis चे आजार आणि माहिती.",
    es: "Un resumen clínico completo de Osteoarthritis.",
    ar: "نظرة عامة سريرية شاملة لـ Osteoarthritis."
  },
  content: {
    overview: "Osteoarthritis is a common clinical condition managed in outpatient clinics. An integrated approach combining lifestyle modification and constitutional support yields optimal long-term outcomes.",
    definition: "Osteoarthritis is defined clinically as a pathological or functional condition affecting systemic homeostasis.",
    causes: [
    ...
    symptoms: [
      "Typical physical symptoms associated with Osteoarthritis.",
  ...
  tags: ["Osteoarthritis", "Disease", "Clinical-Overview"],
  canonicalUrl: "https://homeo.healthcare/knowledge/diseases/osteoarthritis",
  readingTimeMinutes: 5,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Osteoarthritis profile"]
};
