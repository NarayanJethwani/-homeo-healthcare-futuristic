...
export const DizzinessSymptom: KnowledgeEntity = {
  ...
  summary: {
    en: "Clinical definition, significance, causes, and supportive management of Dizziness.",
    hi: "Dizziness के लक्षण की नैदानिक समझ.",
    gu: "Dizziness ના લક્ષણ ની સમજણ.",
    mr: "Dizziness चे लक्षण आणि उपचार.",
    es: "Definición clínica y significado de Dizziness.",
    ar: "التعريف السريري والأهمية لـ Dizziness."
  },
  content: {
    definition: "Dizziness represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Dizziness helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
