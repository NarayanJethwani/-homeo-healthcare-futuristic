...
export const FeverSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Fever represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Fever helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
