...
export const NightSweatsSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Night Sweats represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Night Sweats helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
