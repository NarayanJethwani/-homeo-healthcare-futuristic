...
export const VomitingSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Vomiting represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Vomiting helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
