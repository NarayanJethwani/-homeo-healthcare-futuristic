...
export const SkinEruptionsSymptom: KnowledgeEntity = {
  ...
  content: {
  "definition": "Skin eruptions: A subjective or visible skin manifestation representing cutaneous inflammation, epidermal barrier damage, or localized histamine release.",
