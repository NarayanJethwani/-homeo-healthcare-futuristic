...
export const BurningUrinationSymptom: KnowledgeEntity = {
  id: "S0052",
  ...
  title: {
    en: "Burning Urination",
    hi: "Burning Urination",
    gu: "Burning Urination",
    mr: "Burning Urination",
    es: "Burning Urination",
  ...
  summary: {
    ...
    es: "Definición clínica y significado de Burning Urination.",
  ...
  tags: ["Burning Urination", "Symptom", "Clinical"],
  canonicalUrl: "https://homeo.healthcare/knowledge/symptoms/burning-urination",
  readingTimeMinutes: 3,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Burning Urination symptom profile"]
};
