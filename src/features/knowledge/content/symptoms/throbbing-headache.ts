...
export const ThrobbingHeadacheSymptom: KnowledgeEntity = {
  id: "S0064",
  slug: "throbbing-headache",
  entityType: "symptom",
  ...
  title: {
    ...
    hi: "Throbbing Headache",
    gu: "Throbbing Headache",
    mr: "Throbbing Headache",
    es: "Throbbing Headache",
    ar: "Throbbing Headache"
  },
  summary: {
    en: "Clinical definition, significance, causes, and supportive management of Throbbing Headache.",
    hi: "Throbbing Headache के लक्षण की नैदानिक समझ.",
    gu: "Throbbing Headache ના લક્ષણ ની સમજણ.",
    mr: "Throbbing Headache चे लक्षण आणि उपचार.",
    es: "Definición clínica y significado de Throbbing Headache.",
    ar: "التعريف السريري والأهمية لـ Throbbing Headache."
  },
  content: {
  "definition": "Throbbing headache: A localized pain, sensory alteration, or mobility limitation originating from nerves, muscles, joints, or tendons.",
  ...
  tags: ["Throbbing Headache", "Symptom", "Clinical"],
  canonicalUrl: "https://homeo.healthcare/knowledge/symptoms/throbbing-headache",
  readingTimeMinutes: 3,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Throbbing Headache symptom profile"]
};
