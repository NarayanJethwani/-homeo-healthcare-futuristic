...
export const DryCoughSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Dry Cough represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Dry Cough helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
