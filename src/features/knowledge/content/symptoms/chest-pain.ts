...
export const ChestPainSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Chest Pain represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Chest Pain helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
