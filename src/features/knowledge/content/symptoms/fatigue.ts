...
export const FatigueSymptom: KnowledgeEntity = {
  ...
  summary: {
    en: "Clinical definition, significance, causes, and supportive management of Fatigue.",
    hi: "Fatigue के लक्षण की नैदानिक समझ.",
    gu: "Fatigue ના લક્ષણ ની સમજણ.",
    mr: "Fatigue चे लक्षण आणि उपचार.",
    es: "Definición clínica y significado de Fatigue.",
    ar: "التعريف السريري والأهمية لـ Fatigue."
  },
  content: {
    definition: "Fatigue represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Fatigue helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
