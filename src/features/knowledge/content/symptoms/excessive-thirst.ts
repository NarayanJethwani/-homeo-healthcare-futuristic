...
export const ExcessiveThirstSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Excessive Thirst represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Excessive Thirst helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
