...
export const SneezingSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Sneezing represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Sneezing helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
