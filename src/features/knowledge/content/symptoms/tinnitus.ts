...
export const TinnitusSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Tinnitus represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Tinnitus helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
