...
export const TinglingSymptom: KnowledgeEntity = {
  ...
  content: {
    definition: "Tingling represents a functional or sensory manifestation indicating systemic reaction or localized pathological change.",
    clinicalMeaning: "In clinical practice, monitoring Tingling helps evaluate disease progress and individual metabolic response.",
    commonCauses: [
