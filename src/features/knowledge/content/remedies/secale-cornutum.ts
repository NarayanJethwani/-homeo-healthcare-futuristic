...
export const SecaleCornutumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Secale Cornutum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Secale Cornutum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Secale Cornutum.",
