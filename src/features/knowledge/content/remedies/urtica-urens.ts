...
export const UrticaUrensRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Urtica Urens source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Urtica Urens is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Urtica Urens.",
