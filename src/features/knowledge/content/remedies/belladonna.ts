...
export const BelladonnaRemedy: KnowledgeEntity = {
  ...
  "commonName": "Belladonna Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy belladonna is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
    "Modalities of aggravation and amelioration unique to belladonna.",
  ...
  "physicalSymptoms": [
    "Localized burning, stitching, or throbbing sensations typical of belladonna.",
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to belladonna pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
