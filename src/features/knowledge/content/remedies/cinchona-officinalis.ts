...
export const CinchonaOfficinalisRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Cinchona Officinalis source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Cinchona Officinalis is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Cinchona Officinalis.",
