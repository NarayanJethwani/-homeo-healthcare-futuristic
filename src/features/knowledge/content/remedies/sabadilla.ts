...
export const SabadillaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Sabadilla source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Sabadilla is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Sabadilla.",
