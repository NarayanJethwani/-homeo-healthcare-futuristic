...
export const AcidumNitricumRemedy: KnowledgeEntity = {
  id: "R0102",
  ...
  title: {
    en: "Acidum Nitricum (Nitric Acid)",
    hi: "Acidum Nitricum",
    gu: "Acidum Nitricum",
    mr: "Acidum Nitricum",
    es: "Acidum Nitricum",
  ...
  summary: {
    en: "A clinically vital homeopathic remedy with primary affinities for the Skin Outlets and Mucous Membranes and Glands.",
    hi: "Acidum Nitricum का होम्योपैथिक विवरण.",
    gu: "Acidum Nitricum હોમિયોપેથિક દવા.",
    mr: "Acidum Nitricum चे होमिओपॅथी माहिती.",
    es: "Un remedio homeopático clave con afinidad clínica para Skin Outlets y Mucous Membranes y Glands.",
    ar: "علاج مثلي هام ذو تقارب سريري لـ Skin Outlets و Mucous Membranes و Glands."
  },
  content: {
  "latinName": "Acidum Nitricum",
  "commonName": "Acidum nitricum Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy acidum nitricum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
    "Modalities of aggravation and amelioration unique to acidum nitricum.",
  ...
  "physicalSymptoms": [
    "Localized burning, stitching, or throbbing sensations typical of acidum nitricum.",
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to acidum nitricum pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
  ...
  tags: ["Acidum Nitricum", "Remedy", "Homeopathy"],
  canonicalUrl: "https://homeo.healthcare/knowledge/remedies/acidum-nitricum",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Acidum Nitricum remedy profile"]
};
