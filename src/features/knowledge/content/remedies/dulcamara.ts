...
export const DulcamaraRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Dulcamara source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Dulcamara is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Dulcamara.",
