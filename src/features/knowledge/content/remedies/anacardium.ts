...
export const AnacardiumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Anacardium source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Anacardium is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Anacardium.",
