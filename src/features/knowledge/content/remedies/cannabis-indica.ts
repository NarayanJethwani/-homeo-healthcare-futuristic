...
export const CannabisIndicaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Cannabis Indica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Cannabis Indica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Cannabis Indica.",
