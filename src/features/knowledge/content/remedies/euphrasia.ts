...
export const EuphrasiaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Euphrasia source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Euphrasia is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Euphrasia.",
