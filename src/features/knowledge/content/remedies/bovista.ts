...
export const BovistaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Bovista source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Bovista is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Bovista.",
