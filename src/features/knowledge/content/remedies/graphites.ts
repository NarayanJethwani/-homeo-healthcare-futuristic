...
export const GraphitesRemedy: KnowledgeEntity = {
  id: "R0045",
  slug: "graphites",
  entityType: "remedy",
  ...
  content: {
    ...
    source: "Graphites source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Graphites is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Graphites.",
