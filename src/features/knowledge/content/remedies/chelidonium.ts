...
export const ChelidoniumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Chelidonium source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Chelidonium is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Chelidonium.",
