...
export const PyrogeniumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Pyrogenium source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Pyrogenium is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Pyrogenium.",
