...
export const StramoniumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Stramonium source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Stramonium is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Stramonium.",
