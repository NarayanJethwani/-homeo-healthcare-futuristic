...
export const CalcareaPhosphoricaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Calcarea Phosphorica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Calcarea Phosphorica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Calcarea Phosphorica.",
