...
export const ValerianaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Valeriana source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Valeriana is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Valeriana.",
