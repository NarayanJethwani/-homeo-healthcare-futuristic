...
export const CicutaVirosaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Cicuta Virosa source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Cicuta Virosa is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Cicuta Virosa.",
