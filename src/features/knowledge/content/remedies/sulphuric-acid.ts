...
export const SulphuricAcidRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Sulphuric Acid source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Sulphuric Acid is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Sulphuric Acid.",
