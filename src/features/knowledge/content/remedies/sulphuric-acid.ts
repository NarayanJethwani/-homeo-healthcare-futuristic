...
export const SulphuricAcidRemedy: KnowledgeEntity = {
  ...
  title: {
    en: "Sulphuric Acid (Sulphuric Acid Common)",
    hi: "Sulphuric Acid",
    gu: "Sulphuric Acid",
    mr: "Sulphuric Acid",
    es: "Sulphuric Acid",
  ...
  summary: {
    ...
    hi: "Sulphuric Acid का होम्योपैथिक विवरण.",
    gu: "Sulphuric Acid હોમિયોપેથિક દવા.",
    mr: "Sulphuric Acid चे होमिओपॅथी माहिती.",
  ...
  content: {
  "latinName": "Sulphuric Acid",
  "commonName": "Sulphuric acid Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy sulphuric acid is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to sulphuric acid pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
  ...
  tags: ["Sulphuric Acid", "Remedy", "Homeopathy"],
  canonicalUrl: "https://homeo.healthcare/knowledge/remedies/sulphuric-acid",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Sulphuric Acid remedy profile"]
};
