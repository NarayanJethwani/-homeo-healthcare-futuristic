...
export const AloeSocotrinaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Aloe Socotrina source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Aloe Socotrina is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Aloe Socotrina.",
