...
export const CalcareaFluoricaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Calcarea Fluorica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Calcarea Fluorica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Calcarea Fluorica.",
