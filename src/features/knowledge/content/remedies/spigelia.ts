...
export const SpigeliaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Spigelia source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Spigelia is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Spigelia.",
