...
export const BerberisVulgarisRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Berberis Vulgaris source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Berberis Vulgaris is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Berberis Vulgaris.",
