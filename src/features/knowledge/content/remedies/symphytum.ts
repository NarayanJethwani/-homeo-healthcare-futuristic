...
export const SymphytumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Symphytum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Symphytum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Symphytum.",
