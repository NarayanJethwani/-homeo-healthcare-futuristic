...
export const HamamelisRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Hamamelis source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Hamamelis is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Hamamelis.",
