...
export const TarentulaHispanicaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Tarentula Hispanica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Tarentula Hispanica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Tarentula Hispanica.",
