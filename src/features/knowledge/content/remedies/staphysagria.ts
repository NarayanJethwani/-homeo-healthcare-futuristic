...
export const StaphysagriaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Staphysagria source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Staphysagria is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Staphysagria.",
