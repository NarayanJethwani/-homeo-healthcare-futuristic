...
export const IpecacuanhaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Ipecacuanha source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Ipecacuanha is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Ipecacuanha.",
