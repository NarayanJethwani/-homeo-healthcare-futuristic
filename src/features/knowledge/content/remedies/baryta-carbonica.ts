...
export const BarytaCarbonicaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Baryta Carbonica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Baryta Carbonica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Baryta Carbonica.",
