...
export const CausticumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Causticum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Causticum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Causticum.",
