...
export const AntimoniumCrudumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Antimonium Crudum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Antimonium Crudum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Antimonium Crudum.",
