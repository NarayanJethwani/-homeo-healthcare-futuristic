...
export const BufoRanaRemedy: KnowledgeEntity = {
  id: "R0132",
  slug: "bufo-rana",
  entityType: "remedy",
  ...
  summary: {
    en: "A clinically vital homeopathic remedy with primary affinities for the Nerves and Mind and Skin.",
    hi: "Bufo Rana का होम्योपैथिक विवरण.",
    gu: "Bufo Rana હોમિયોપેથિક દવા.",
    mr: "Bufo Rana चे होमिओपॅथी माहिती.",
    es: "Un remedio homeopático clave con afinidad clínica para Nerves y Mind y Skin.",
    ar: "علاج مثلي هام ذو تقارب سريري لـ Nerves و Mind و Skin."
  },
  content: {
  "latinName": "Bufo Rana",
  "commonName": "Bufo rana Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy bufo rana is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
    "Modalities of aggravation and amelioration unique to bufo rana.",
  ...
  "physicalSymptoms": [
    "Localized burning, stitching, or throbbing sensations typical of bufo rana.",
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to bufo rana pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
  ...
  tags: ["Bufo Rana", "Remedy", "Homeopathy"],
  canonicalUrl: "https://homeo.healthcare/knowledge/remedies/bufo-rana",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Bufo Rana remedy profile"]
};
