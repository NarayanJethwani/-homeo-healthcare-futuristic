...
export const ApisMellificaRemedy: KnowledgeEntity = {
  id: "R0026",
  slug: "apis-mellifica",
  entityType: "remedy",
  ...
  content: {
    ...
    source: "Apis Mellifica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Apis Mellifica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Apis Mellifica.",
