...
export const KreosotumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Kreosotum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Kreosotum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Kreosotum.",
