...
export const ArgentumNitricumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Argentum Nitricum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Argentum Nitricum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Argentum Nitricum.",
