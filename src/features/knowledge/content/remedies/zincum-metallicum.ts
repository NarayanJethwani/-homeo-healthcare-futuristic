...
export const ZincumMetallicumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Zincum Metallicum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Zincum Metallicum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Zincum Metallicum.",
