...
export const SanguinariaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Sanguinaria source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Sanguinaria is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Sanguinaria.",
