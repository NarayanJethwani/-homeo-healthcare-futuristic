...
export const FerrumPhosphoricumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Ferrum Phosphoricum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Ferrum Phosphoricum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Ferrum Phosphoricum.",
