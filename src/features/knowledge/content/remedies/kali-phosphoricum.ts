...
export const KaliPhosphoricumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Kali Phosphoricum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Kali Phosphoricum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Kali Phosphoricum.",
