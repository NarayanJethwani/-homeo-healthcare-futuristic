...
export const SabinaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Sabina source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Sabina is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Sabina.",
