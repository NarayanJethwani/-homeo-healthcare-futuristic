...
export const RutaGraveolensRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Ruta Graveolens source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Ruta Graveolens is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Ruta Graveolens.",
