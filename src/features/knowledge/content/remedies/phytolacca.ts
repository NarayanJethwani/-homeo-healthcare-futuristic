...
export const PhytolaccaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Phytolacca source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Phytolacca is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Phytolacca.",
