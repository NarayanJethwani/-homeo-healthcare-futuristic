...
export const BellsRemedy: KnowledgeEntity = {
  id: "R0086",
  slug: "bells",
  entityType: "remedy",
  ...
  summary: {
    ...
    hi: "Bells का होम्योपैथिक विवरण.",
    gu: "Bells હોમિયોપેથિક દવા.",
    mr: "Bells चे होमिओपॅथी माहिती.",
  ...
  content: {
  "latinName": "Bells",
  "commonName": "Bells Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy bells is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
    "Modalities of aggravation and amelioration unique to bells.",
  ...
  "physicalSymptoms": [
    "Localized burning, stitching, or throbbing sensations typical of bells.",
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to bells pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
  ...
  tags: ["Bells", "Remedy", "Homeopathy"],
  canonicalUrl: "https://homeo.healthcare/knowledge/remedies/bells",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Bells remedy profile"]
};
