...
export const BellsRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Bells source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Bells is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Bells.",
