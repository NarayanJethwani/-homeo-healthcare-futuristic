...
export const ClematisRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Clematis source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Clematis is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Clematis.",
