...
export const MagnesiaPhosphoricaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Magnesia Phosphorica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Magnesia Phosphorica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Magnesia Phosphorica.",
