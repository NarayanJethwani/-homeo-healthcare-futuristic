...
export const EupatoriumPerfoliatumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Eupatorium Perfoliatum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Eupatorium Perfoliatum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Eupatorium Perfoliatum.",
