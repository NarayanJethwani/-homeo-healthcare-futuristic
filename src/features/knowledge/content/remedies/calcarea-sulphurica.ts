...
export const CalcareaSulphuricaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Calcarea Sulphurica source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Calcarea Sulphurica is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Calcarea Sulphurica.",
