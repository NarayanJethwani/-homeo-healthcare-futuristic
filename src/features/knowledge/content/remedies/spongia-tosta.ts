...
export const SpongiaTostaRemedy: KnowledgeEntity = {
  id: "R0069",
  slug: "spongia-tosta",
  entityType: "remedy",
  ...
  content: {
    ...
    source: "Spongia Tosta source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Spongia Tosta is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Spongia Tosta.",
