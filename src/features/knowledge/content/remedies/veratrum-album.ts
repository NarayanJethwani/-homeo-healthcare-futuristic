...
export const VeratrumAlbumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Veratrum Album source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Veratrum Album is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Veratrum Album.",
