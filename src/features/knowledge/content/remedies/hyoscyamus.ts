...
export const HyoscyamusRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Hyoscyamus source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Hyoscyamus is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Hyoscyamus.",
