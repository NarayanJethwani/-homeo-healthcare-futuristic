...
export const BoraxRemedy: KnowledgeEntity = {
  ...
  summary: {
    ...
    hi: "Borax का होम्योपैथिक विवरण.",
    gu: "Borax હોમિયોપેથિક દવા.",
    mr: "Borax चे होमिओपॅथी माहिती.",
  ...
  content: {
  "latinName": "Borax",
  "commonName": "Borax Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy borax is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
    "Modalities of aggravation and amelioration unique to borax.",
  ...
  "physicalSymptoms": [
    "Localized burning, stitching, or throbbing sensations typical of borax.",
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to borax pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
  ...
  tags: ["Borax", "Remedy", "Homeopathy"],
  canonicalUrl: "https://homeo.healthcare/knowledge/remedies/borax",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Borax remedy profile"]
};
