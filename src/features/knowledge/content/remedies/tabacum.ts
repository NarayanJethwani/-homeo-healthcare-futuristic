...
export const TabacumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Tabacum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Tabacum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Tabacum.",
