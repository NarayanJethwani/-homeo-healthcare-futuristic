...
export const HypericumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Hypericum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Hypericum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Hypericum.",
