...
export const CinaMaritimaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Cina Maritima source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Cina Maritima is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Cina Maritima.",
