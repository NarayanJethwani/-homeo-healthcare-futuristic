...
export const BaptisiaTinctoriaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Baptisia Tinctoria source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Baptisia Tinctoria is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Baptisia Tinctoria.",
