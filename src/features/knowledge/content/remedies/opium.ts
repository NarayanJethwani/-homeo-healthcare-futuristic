...
export const OpiumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Opium source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Opium is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Opium.",
