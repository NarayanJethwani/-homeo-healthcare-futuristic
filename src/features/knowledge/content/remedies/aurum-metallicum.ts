...
export const AurumMetallicumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Aurum Metallicum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Aurum Metallicum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Aurum Metallicum.",
