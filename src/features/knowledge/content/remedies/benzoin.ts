...
export const BenzoinRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Benzoin source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Benzoin is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Benzoin.",
