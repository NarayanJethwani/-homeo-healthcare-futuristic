...
export const CapsicumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Capsicum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Capsicum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Capsicum.",
