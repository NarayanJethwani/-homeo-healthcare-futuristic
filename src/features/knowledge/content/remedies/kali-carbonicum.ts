...
export const KaliCarbonicumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Kali Carbonicum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Kali Carbonicum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Kali Carbonicum.",
