...
export const LachesisMutaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Lachesis Muta source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Lachesis Muta is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Lachesis Muta.",
