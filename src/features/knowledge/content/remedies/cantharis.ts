...
export const CantharisRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Cantharis source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Cantharis is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Cantharis.",
