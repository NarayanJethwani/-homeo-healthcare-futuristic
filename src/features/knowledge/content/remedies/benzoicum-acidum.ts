...
export const BenzoicumAcidumRemedy: KnowledgeEntity = {
  id: "R0128",
  slug: "benzoicum-acidum",
  entityType: "remedy",
  ...
  title: {
    en: "Benzoicum Acidum (Benzoic Acid)",
    hi: "Benzoicum Acidum",
    gu: "Benzoicum Acidum",
    mr: "Benzoicum Acidum",
    es: "Benzoicum Acidum",
  ...
  summary: {
    en: "A clinically vital homeopathic remedy with primary affinities for the Kidneys and Joints and Bladder.",
    hi: "Benzoicum Acidum का होम्योपैथिक विवरण.",
    gu: "Benzoicum Acidum હોમિયોપેથિક દવા.",
    mr: "Benzoicum Acidum चे होमिओपॅथी माहिती.",
    es: "Un remedio homeopático clave con afinidad clínica para Kidneys y Joints y Bladder.",
    ar: "علاج مثلي هام ذو تقارب سريري لـ Kidneys و Joints و Bladder."
  },
  content: {
  "latinName": "Benzoicum Acidum",
  "commonName": "Benzoicum acidum Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy benzoicum acidum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
    "Modalities of aggravation and amelioration unique to benzoicum acidum.",
  ...
  "physicalSymptoms": [
    "Localized burning, stitching, or throbbing sensations typical of benzoicum acidum.",
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to benzoicum acidum pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
  ...
  tags: ["Benzoicum Acidum", "Remedy", "Homeopathy"],
  canonicalUrl: "https://homeo.healthcare/knowledge/remedies/benzoicum-acidum",
  readingTimeMinutes: 4,
  audience: "patient",
  license: "CC BY-NC-ND 4.0",
  changeLog: ["1.0.0: Initial release of Benzoicum Acidum remedy profile"]
};
