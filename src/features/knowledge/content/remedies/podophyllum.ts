...
export const PodophyllumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Podophyllum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Podophyllum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Podophyllum.",
