...
export const CannabisSativaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Cannabis Sativa source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Cannabis Sativa is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Cannabis Sativa.",
