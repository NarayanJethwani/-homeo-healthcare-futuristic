...
export const CaladiumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Caladium source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Caladium is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Caladium.",
