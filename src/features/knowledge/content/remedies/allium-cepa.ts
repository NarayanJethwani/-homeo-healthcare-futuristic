...
export const AlliumCepaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Allium Cepa source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Allium Cepa is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Allium Cepa.",
