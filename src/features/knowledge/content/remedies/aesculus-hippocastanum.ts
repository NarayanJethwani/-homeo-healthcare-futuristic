...
export const AesculusHippocastanumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Aesculus Hippocastanum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Aesculus Hippocastanum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Aesculus Hippocastanum.",
