...
export const LedumPalustreRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Ledum Palustre source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Ledum Palustre is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Ledum Palustre.",
