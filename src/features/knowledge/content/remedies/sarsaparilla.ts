...
export const SarsaparillaRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Sarsaparilla source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Sarsaparilla is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Sarsaparilla.",
