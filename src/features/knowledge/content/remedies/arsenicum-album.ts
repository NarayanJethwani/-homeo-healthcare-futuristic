...
export const ArsenicumAlbumRemedy: KnowledgeEntity = {
  ...
  "commonName": "Arsenicum album Common",
  "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
  "kingdom": "Plant",
  "remedyType": "Polychrest",
  "description": "The remedy arsenicum album is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
  "keynotes": [
    "Modalities of aggravation and amelioration unique to arsenicum album.",
  ...
  "physicalSymptoms": [
    "Localized burning, stitching, or throbbing sensations typical of arsenicum album.",
  ...
  "constitution": "Suited to individuals showing typical reactivity corresponding to arsenicum album pathogenesis.",
  "potencies": [
    "6C",
    "30C",
    "200C",
