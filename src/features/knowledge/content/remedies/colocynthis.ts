...
export const ColocynthisRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Colocynthis source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Colocynthis is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Colocynthis.",
