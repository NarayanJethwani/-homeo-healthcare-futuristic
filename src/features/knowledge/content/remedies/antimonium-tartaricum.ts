...
export const AntimoniumTartaricumRemedy: KnowledgeEntity = {
  ...
  content: {
    ...
    source: "Antimonium Tartaricum source material",
    kingdom: "Plant",
    remedyType: "Polychrest",
    description: "Antimonium Tartaricum is prepared in accordance with homeopathic pharmacopoeia principles. It has a significant clinical legacy and provides deep constitutional support.",
    keynotes: [
    "Key clinical indication 1 for Antimonium Tartaricum.",
