...
export const ANATOMY_SYSTEMS: AnatomySystem[] = [
  ...
  },
  {
    ...
    lightAccent: "#f8fafc",
    overview:
      "The skeletal system provides support and protection, acts as a framework for movement, stores minerals, and contains marrow involved in blood-cell production.",
    ...
    reference: {
      title: "7.1 Divisions of the Skeletal System — Anatomy and Physiology 2e",
      publisher: "OpenStax, Rice University",
  ...
  },
  {
    ...
    lightAccent: "#fef2f2",
    overview:
      "Skeletal muscles generate voluntary movement and maintain posture, while smooth and cardiac muscle support organ and circulatory function.",
    ...
    reference: {
      title: "10.2 Skeletal Muscle — Anatomy and Physiology 2e",
      publisher: "OpenStax, Rice University",
  ...
  },
  {
    ...
    lightAccent: "#fffbeb",
    overview:
      "The endocrine system uses hormones released into the circulation to coordinate metabolism, growth, reproduction, stress responses, and internal homeostasis.",
    ...
    reference: {
      title: "17.1 An Overview of the Endocrine System — Anatomy and Physiology 2e",
      publisher: "OpenStax, Rice University",
      url: "https://openstax.org/books/anatomy-and-physiology-2e/pages/17-1-an-overview-of-the-endocrine-system",
      evidenceType: "Open textbook",
      reviewedOn: "2026-08-19",
    },
  },
  {
    ...
    lightAccent: "#f0fdf4",
    overview:
      "The lymphatic system returns interstitial fluid to the circulation, transports absorbed lipids, and provides organs and pathways for immune surveillance.",
    ...
    reference: {
      title: "21.1 Anatomy of the Lymphatic and Immune Systems — Anatomy and Physiology 2e",
      publisher: "OpenStax, Rice University",
  ...
  },
  {
    ...
    lightAccent: "#fdf2f8",
    overview:
      "The reproductive system produces gametes and sex hormones and includes sex-specific internal and external structures involved in reproduction.",
    ...
    reference: {
      title: "27.1 Anatomy and Physiology of the Male Reproductive System — Anatomy and Physiology 2e",
      publisher: "OpenStax, Rice University",
  ...
  },
  {
    ...
    lightAccent: "#fff7ed",
    overview:
      "The integumentary system forms the body's external barrier through skin and its appendages, contributing to protection, sensation, temperature control, and vitamin D synthesis.",
    ...
    reference: {
      title: "5.1 Layers of the Skin — Anatomy and Physiology 2e",
      publisher: "OpenStax, Rice University",
  ...
  },
  {
    ...
    lightAccent: "#eff6ff",
    overview:
      "Specialized sensory organs transduce light, sound, head movement, taste, and smell into neural signals interpreted by the central nervous system.",
    ...
    reference: {
      title: "14.1 Sensory Perception — Anatomy and Physiology 2e",
      publisher: "OpenStax, Rice University",
