...
export const CLINICAL_CARE_TIER_OPTIONS: Record<StoreClinicalCareTierId, ClinicalCareTierOption> = {
  ...
  membership_integrated: {
    ...
    description: "For one person with related mild, stable concerns involving two organ systems and suitable for lower-intensity follow-up.",
    recommendedFor: "Related mild, stable concerns involving two organ systems",
  },
  membership_comprehensive: {
    ...
    description: "For one person with multiple mild, stable concerns across organ systems requiring broader case review.",
    recommendedFor: "Multiple mild, stable concerns across organ systems as required",
  },
  focused: {
    id: "focused",
    family: "chronic",
