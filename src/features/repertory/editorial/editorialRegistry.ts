import { EditorialSource, EditorialRecord } from './editorialTypes';

export const SYSTEM_SOURCES_REGISTRY: Record<string, EditorialSource> = {
  'hahnemann_cd': {
    id: 'hahnemann_cd',
...
export const EDITORIAL_RECORDS_REGISTRY: Record<string, EditorialRecord[]> = {
  'Ars': [
    {
      id: 'rec_ars_jethwani',
      remedyId: 'Ars',
