import { SuggestedQuestion, RepertoryRubric } from '../types';
...
export class FollowUpEngine {
  ...
  public static async generateFollowUpQuestions(
    symptoms: Array<{ rubricId: string; severity: number; frequency: string; impact: string }>,
    topRemedies: Array<{ remedyId: string; remedyName: string; score: number; confidence: number; contradictoryEvidence?: string[] }>
