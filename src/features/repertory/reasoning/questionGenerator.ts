...
import { SuggestedQuestion, MissingInformationItem, RepertoryRubric } from '../types';
...
export class QuestionGenerator {
   ...
   */
  static async getMissingInformation(
  ...
  static async generateQuestions(
    ...
    const QUESTION_MAP: Record<string, SuggestedQuestion> = {
      thermal: {
        key: 'thermal',
