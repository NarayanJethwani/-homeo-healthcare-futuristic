export interface Rubric {
  ...
  source?: "kent" | "boericke" | "clarke" | "boger" | "knerr" | "boenninghausen" | "gentry";
...
export function getRepertoryData(source: 'kent' | 'boericke' | 'clarke' | 'boger' | 'knerr' | 'boenninghausen' | 'gentry' | 'combined'): Rubric[] {
