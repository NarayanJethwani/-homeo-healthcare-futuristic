...
exports.generateMedicalWebPageSchema = generateMedicalWebPageSchema;
...
exports.generatePhysicianSchema = generatePhysicianSchema;
exports.generateClinicSchema = generateClinicSchema;
/**
 * Helper to generate MedicalWebPage schema (combining clinical topic features)
 */
function generateMedicalWebPageSchema(entity) {
 ...
 */
function generateArticleSchema(entity) {
    const title = typeof entity.title === "string" ? entity.title : (entity.title?.en || "");
    const summary = typeof entity.summary === "string" ? entity.summary : (entity.summary?.en || "");
    return {
        "@context": "https://schema.org",
 ...
 */
function generatePhysicianSchema() {
    return {
        "@context": "https://schema.org",
        "@type": "Physician",
