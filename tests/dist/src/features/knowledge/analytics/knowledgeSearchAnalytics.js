...
exports.redactSensitiveSearchQuery = redactSensitiveSearchQuery;
exports.normalizeQuery = normalizeQuery;
exports.trackSearchQuery = trackSearchQuery;
exports.getSearchAnalyticsSummary = getSearchAnalyticsSummary;
const firebaseAdmin_1 = require("../../../lib/firebaseAdmin");
// In-memory runtime cache for serverless sessions/fallback
const searchLogsInMemoryCache = [];
/**
 * Normalizes query string and redacts PII/PHI.
 */
function redactSensitiveSearchQuery(query) {
    if (!query)
        return "";
 ...
 */
async function trackSearchQuery(entry) {
 ...
 */
async function getSearchAnalyticsSummary() {
