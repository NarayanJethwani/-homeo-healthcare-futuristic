...
exports.SerumIronLabTest = void 0;
exports.SerumIronLabTest = {
    id: "L0027",
    slug: "serum-iron",
    entityType: "lab-test",
    ...
    summary: {
        en: "Clinical purpose, normal range, and interpretation of Serum Iron lab results.",
        hi: "Serum Iron प्रयोगशाला परीक्षण विवरण.",
        gu: "Serum Iron લેબોરેટરી ટેસ્ટ પરિચય.",
        mr: "Serum Iron लॅब टेस्ट माहिती.",
        es: "Propósito e interpretación de la prueba de laboratorio Serum Iron.",
        ar: "الغرض السريري وتفسير نتائج اختبار Serum Iron."
    },
    content: {
        "overview": "SERUM IRON: A blood panel parameter or cell count analysis designed to evaluate red cell mass, immune defense lines, and coagulation potential.",
        ...
        "clinicalInterpretation": "SERUM IRON evaluation: Red cell and hemoglobin drops suggest anemia, necessitating iron, B12, or folate evaluation. WBC spikes indicate infection or severe inflammation, while platelet drops warn of bleeding risks.",
        "references": [
            "CIT-0015",
            "CIT-0016",
            "CIT-0022"
    ...
    tags: ["Serum Iron", "Lab-Test", "Diagnostics"],
    canonicalUrl: "https://homeo.healthcare/knowledge/lab-tests/serum-iron",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Serum Iron test guidelines"]
};
