...
exports.ChillsSymptom = void 0;
exports.ChillsSymptom = {
    id: "S0063",
    slug: "chills",
    entityType: "symptom",
    ...
    summary: {
        en: "Clinical definition, significance, causes, and supportive management of Chills.",
        hi: "Chills के लक्षण की नैदानिक समझ.",
        gu: "Chills ના લક્ષણ ની સમજણ.",
        mr: "Chills चे लक्षण आणि उपचार.",
        es: "Definición clínica y significado de Chills.",
        ar: "التعريف السريري والأهمية لـ Chills."
    },
    content: {
        "definition": "Chills: A general physical symptom reflecting altered systemic vitality, sleep disruption, or thermal deregulation.",
    ...
    tags: ["Chills", "Symptom", "Clinical"],
    canonicalUrl: "https://homeo.healthcare/knowledge/symptoms/chills",
    readingTimeMinutes: 3,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Chills symptom profile"]
};
