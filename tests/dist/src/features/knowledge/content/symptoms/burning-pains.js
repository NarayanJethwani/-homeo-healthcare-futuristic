...
exports.BurningPainsSymptom = void 0;
exports.BurningPainsSymptom = {
    id: "S0071",
    slug: "burning-pains",
    entityType: "symptom",
    ...
    summary: {
        en: "Clinical definition, significance, causes, and supportive management of Burning Pains.",
        hi: "Burning Pains के लक्षण की नैदानिक समझ.",
        gu: "Burning Pains ના લક્ષણ ની સમજણ.",
        mr: "Burning Pains चे लक्षण आणि उपचार.",
        es: "Definición clínica y significado de Burning Pains.",
        ar: "التعريف السريري والأهمية لـ Burning Pains."
    },
    content: {
        "definition": "Burning pains: A localized pain, sensory alteration, or mobility limitation originating from nerves, muscles, joints, or tendons.",
    ...
    tags: ["Burning Pains", "Symptom", "Clinical"],
    canonicalUrl: "https://homeo.healthcare/knowledge/symptoms/burning-pains",
    readingTimeMinutes: 3,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Burning Pains symptom profile"]
};
