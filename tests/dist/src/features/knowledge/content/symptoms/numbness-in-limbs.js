...
exports.NumbnessinLimbsSymptom = void 0;
exports.NumbnessinLimbsSymptom = {
    id: "S0075",
    slug: "numbness-in-limbs",
    entityType: "symptom",
    ...
    title: {
        ...
        hi: "Numbness in Limbs",
        gu: "Numbness in Limbs",
        mr: "Numbness in Limbs",
        es: "Numbness in Limbs",
        ar: "Numbness in Limbs"
    },
    summary: {
        en: "Clinical definition, significance, causes, and supportive management of Numbness in Limbs.",
        hi: "Numbness in Limbs के लक्षण की नैदानिक समझ.",
        gu: "Numbness in Limbs ના લક્ષણ ની સમજણ.",
        mr: "Numbness in Limbs चे लक्षण आणि उपचार.",
        es: "Definición clínica y significado de Numbness in Limbs.",
        ar: "التعريف السريري والأهمية لـ Numbness in Limbs."
    },
    content: {
        "definition": "Numbness in limbs: A localized pain, sensory alteration, or mobility limitation originating from nerves, muscles, joints, or tendons.",
    ...
    tags: ["Numbness in Limbs", "Symptom", "Clinical"],
    canonicalUrl: "https://homeo.healthcare/knowledge/symptoms/numbness-in-limbs",
    readingTimeMinutes: 3,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Numbness in Limbs symptom profile"]
};
