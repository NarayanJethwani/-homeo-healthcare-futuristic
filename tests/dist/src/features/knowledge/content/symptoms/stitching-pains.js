...
exports.StitchingPainsSymptom = void 0;
exports.StitchingPainsSymptom = {
    id: "S0072",
    slug: "stitching-pains",
    entityType: "symptom",
    ...
    summary: {
        en: "Clinical definition, significance, causes, and supportive management of Stitching Pains.",
        hi: "Stitching Pains के लक्षण की नैदानिक समझ.",
        gu: "Stitching Pains ના લક્ષણ ની સમજણ.",
        mr: "Stitching Pains चे लक्षण आणि उपचार.",
        es: "Definición clínica y significado de Stitching Pains.",
        ar: "التعريف السريري والأهمية لـ Stitching Pains."
    },
    content: {
        "definition": "Stitching pains: A subjective or visible skin manifestation representing cutaneous inflammation, epidermal barrier damage, or localized histamine release.",
    ...
    tags: ["Stitching Pains", "Symptom", "Clinical"],
    canonicalUrl: "https://homeo.healthcare/knowledge/symptoms/stitching-pains",
    readingTimeMinutes: 3,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Stitching Pains symptom profile"]
};
