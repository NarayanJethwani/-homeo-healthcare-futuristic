...
exports.MorningSicknessSymptom = void 0;
exports.MorningSicknessSymptom = {
    id: "S0067",
    ...
    summary: {
        en: "Clinical definition, significance, causes, and supportive management of Morning Sickness.",
        hi: "Morning Sickness के लक्षण की नैदानिक समझ.",
        gu: "Morning Sickness ના લક્ષણ ની સમજણ.",
        mr: "Morning Sickness चे लक्षण आणि उपचार.",
        es: "Definición clínica y significado de Morning Sickness.",
        ar: "التعريف السريري والأهمية لـ Morning Sickness."
    },
    content: {
        "definition": "Morning sickness: A general physical symptom reflecting altered systemic vitality, sleep disruption, or thermal deregulation.",
    ...
    tags: ["Morning Sickness", "Symptom", "Clinical"],
    canonicalUrl: "https://homeo.healthcare/knowledge/symptoms/morning-sickness",
    readingTimeMinutes: 3,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Morning Sickness symptom profile"]
};
