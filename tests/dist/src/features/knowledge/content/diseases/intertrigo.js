...
exports.IntertrigoDisease = void 0;
exports.IntertrigoDisease = {
    id: "D0074",
    slug: "intertrigo",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Intertrigo, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Intertrigo का नैदानिक विवरण.",
        gu: "Intertrigo નો તબીબી પરિચય.",
        mr: "Intertrigo चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Intertrigo.",
        ar: "نظرة عامة سريرية شاملة لـ Intertrigo."
    },
    content: {
        "overview": "Intertrigo: Dermatological inflammatory conditions represent cutaneous manifestations of immune-mediated dysregulation, genetic skin barrier defects, and autonomic reactivity. Management focuses on skin barrier integrity and systemic immunomodulation.",
    ...
    tags: ["Intertrigo", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/intertrigo",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Intertrigo profile"]
};
