...
exports.LaryngitisDisease = void 0;
exports.LaryngitisDisease = {
    id: "D0061",
    slug: "laryngitis",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Laryngitis, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Laryngitis का नैदानिक विवरण.",
        gu: "Laryngitis નો તબીબી પરિચય.",
        mr: "Laryngitis चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Laryngitis.",
        ar: "نظرة عامة سريرية شاملة لـ Laryngitis."
    },
    content: {
        "overview": "Laryngitis: Allergic and inflammatory respiratory tract conditions involve mucosal hypersensitivity, hyper-responsiveness, and chronic inflammatory cells. Care focuses on mucosal stabilization and reducing allergic hyper-reactivity.",
    ...
    tags: ["Laryngitis", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/laryngitis",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Laryngitis profile"]
};
