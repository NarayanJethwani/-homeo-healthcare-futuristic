...
exports.OralThrushDisease = void 0;
exports.OralThrushDisease = {
    id: "D0065",
    slug: "oral-thrush",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Oral Thrush, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Oral Thrush का नैदानिक विवरण.",
        gu: "Oral Thrush નો તબીબી પરિચય.",
        mr: "Oral Thrush चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Oral Thrush.",
        ar: "نظرة عامة سريرية شاملة لـ Oral Thrush."
    },
    content: {
        "overview": "Oral thrush: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
    ...
    tags: ["Oral Thrush", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/oral-thrush",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Oral Thrush profile"]
};
