...
exports.HypochlorhydriaDisease = void 0;
exports.HypochlorhydriaDisease = {
    id: "D0057",
    ...
    summary: {
        en: "A comprehensive clinical overview of Hypochlorhydria, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Hypochlorhydria का नैदानिक विवरण.",
        gu: "Hypochlorhydria નો તબીબી પરિચય.",
        mr: "Hypochlorhydria चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Hypochlorhydria.",
        ar: "نظرة عامة سريرية شاملة لـ Hypochlorhydria."
    },
    content: {
        "overview": "Hypochlorhydria: Gastrointestinal and functional bowel disorders represent a high-prevalence clinical area involving dysmotility, altered acid secretion, and mucosal inflammation. Effective management relies on stabilizing motility and gut-brain signaling.",
    ...
    tags: ["Hypochlorhydria", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/hypochlorhydria",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Hypochlorhydria profile"]
};
