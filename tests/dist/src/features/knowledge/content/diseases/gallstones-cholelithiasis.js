...
exports.GallstonesCholelithiasisDisease = void 0;
exports.GallstonesCholelithiasisDisease = {
    id: "D0060",
    ...
    title: {
        en: "Gallstones (Cholelithiasis)",
        hi: "Gallstones (Cholelithiasis)",
        gu: "Gallstones (Cholelithiasis)",
        mr: "Gallstones (Cholelithiasis)",
        es: "Gallstones (Cholelithiasis)",
        ar: "Gallstones (Cholelithiasis)"
    },
    summary: {
        en: "A comprehensive clinical overview of Gallstones (Cholelithiasis), covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Gallstones (Cholelithiasis) का नैदानिक विवरण.",
        gu: "Gallstones (Cholelithiasis) નો તબીબી પરિચય.",
        mr: "Gallstones (Cholelithiasis) चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Gallstones (Cholelithiasis).",
        ar: "نظرة عامة سريرية شاملة لـ Gallstones (Cholelithiasis)."
    },
    content: {
        "overview": "Gallstones cholelithiasis: Gastrointestinal and functional bowel disorders represent a high-prevalence clinical area involving dysmotility, altered acid secretion, and mucosal inflammation. Effective management relies on stabilizing motility and gut-brain signaling.",
    ...
    tags: ["Gallstones (Cholelithiasis)", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/gallstones-cholelithiasis",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Gallstones (Cholelithiasis) profile"]
};
