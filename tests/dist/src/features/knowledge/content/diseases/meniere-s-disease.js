...
exports.MenieresDiseaseDisease = void 0;
exports.MenieresDiseaseDisease = {
    id: "D0062",
    ...
    title: {
        ...
        gu: "Meniere's Disease",
        mr: "Meniere's Disease",
        es: "Meniere's Disease",
        ar: "Meniere's Disease"
    },
    summary: {
        en: "A comprehensive clinical overview of Meniere's Disease, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Meniere's Disease का नैदानिक विवरण.",
        gu: "Meniere's Disease નો તબીબી પરિચય.",
        mr: "Meniere's Disease चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Meniere's Disease.",
        ar: "نظرة عامة سريرية شاملة لـ Meniere's Disease."
    },
    content: {
        "overview": "Meniere s disease: Neurological and musculoskeletal conditions affect physical mobility, postural alignment, and sensory nerve conductivity. Management focuses on biomechanical alignment, reducing localized neurogenic inflammation, and pain pathway modulation.",
    ...
    tags: ["Meniere's Disease", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/meniere-s-disease",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Meniere's Disease profile"]
};
