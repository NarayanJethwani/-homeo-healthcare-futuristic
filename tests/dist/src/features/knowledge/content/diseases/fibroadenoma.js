...
exports.FibroadenomaDisease = void 0;
exports.FibroadenomaDisease = {
    id: "D0059",
    slug: "fibroadenoma",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Fibroadenoma, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Fibroadenoma का नैदानिक विवरण.",
        gu: "Fibroadenoma નો તબીબી પરિચય.",
        mr: "Fibroadenoma चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Fibroadenoma.",
        ar: "نظرة عامة سريرية شاملة لـ Fibroadenoma."
    },
    content: {
        "overview": "Fibroadenoma: Dermatological inflammatory conditions represent cutaneous manifestations of immune-mediated dysregulation, genetic skin barrier defects, and autonomic reactivity. Management focuses on skin barrier integrity and systemic immunomodulation.",
    ...
    tags: ["Fibroadenoma", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/fibroadenoma",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Fibroadenoma profile"]
};
