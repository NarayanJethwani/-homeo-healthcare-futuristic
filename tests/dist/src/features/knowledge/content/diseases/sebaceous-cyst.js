...
exports.SebaceousCystDisease = void 0;
exports.SebaceousCystDisease = {
    id: "D0066",
    slug: "sebaceous-cyst",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Sebaceous Cyst, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Sebaceous Cyst का नैदानिक विवरण.",
        gu: "Sebaceous Cyst નો તબીબી પરિચય.",
        mr: "Sebaceous Cyst चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Sebaceous Cyst.",
        ar: "نظرة عامة سريرية شاملة لـ Sebaceous Cyst."
    },
    content: {
        "overview": "Sebaceous cyst: Dermatological inflammatory conditions represent cutaneous manifestations of immune-mediated dysregulation, genetic skin barrier defects, and autonomic reactivity. Management focuses on skin barrier integrity and systemic immunomodulation.",
    ...
    tags: ["Sebaceous Cyst", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/sebaceous-cyst",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Sebaceous Cyst profile"]
};
