...
exports.HypoglycemiaDisease = void 0;
exports.HypoglycemiaDisease = {
    id: "D0072",
    slug: "hypoglycemia",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Hypoglycemia, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Hypoglycemia का नैदानिक विवरण.",
        gu: "Hypoglycemia નો તબીબી પરિચય.",
        mr: "Hypoglycemia चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Hypoglycemia.",
        ar: "نظرة عامة سريرية شاملة لـ Hypoglycemia."
    },
    content: {
        "overview": "Hypoglycemia: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
    ...
    tags: ["Hypoglycemia", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/hypoglycemia",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Hypoglycemia profile"]
};
