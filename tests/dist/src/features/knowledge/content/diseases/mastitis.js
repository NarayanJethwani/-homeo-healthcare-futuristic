...
exports.MastitisDisease = void 0;
exports.MastitisDisease = {
    id: "D0073",
    slug: "mastitis",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Mastitis, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Mastitis का नैदानिक विवरण.",
        gu: "Mastitis નો તબીબી પરિચય.",
        mr: "Mastitis चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Mastitis.",
        ar: "نظرة عامة سريرية شاملة لـ Mastitis."
    },
    content: {
        "overview": "Mastitis: Dermatological inflammatory conditions represent cutaneous manifestations of immune-mediated dysregulation, genetic skin barrier defects, and autonomic reactivity. Management focuses on skin barrier integrity and systemic immunomodulation.",
    ...
    tags: ["Mastitis", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/mastitis",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Mastitis profile"]
};
