...
exports.LowBackPainDisease = void 0;
exports.LowBackPainDisease = {
    id: "D0056",
    slug: "low-back-pain",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Low Back Pain, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Low Back Pain का नैदानिक विवरण.",
        gu: "Low Back Pain નો તબીબી પરિચય.",
        mr: "Low Back Pain चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Low Back Pain.",
        ar: "نظرة عامة سريرية شاملة لـ Low Back Pain."
    },
    content: {
        "overview": "Low back pain: Neurological and musculoskeletal conditions affect physical mobility, postural alignment, and sensory nerve conductivity. Management focuses on biomechanical alignment, reducing localized neurogenic inflammation, and pain pathway modulation.",
    ...
    tags: ["Low Back Pain", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/low-back-pain",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Low Back Pain profile"]
};
