...
exports.RecurrentColdDisease = void 0;
exports.RecurrentColdDisease = {
    id: "D0055",
    slug: "recurrent-cold",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Recurrent Cold, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Recurrent Cold का नैदानिक विवरण.",
        gu: "Recurrent Cold નો તબીબી પરિચય.",
        mr: "Recurrent Cold चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Recurrent Cold.",
        ar: "نظرة عامة سريرية شاملة لـ Recurrent Cold."
    },
    content: {
        "overview": "Recurrent cold: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
    ...
    tags: ["Recurrent Cold", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/recurrent-cold",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Recurrent Cold profile"]
};
