...
exports.SpasmodicDysphoniaDisease = void 0;
exports.SpasmodicDysphoniaDisease = {
    id: "D0071",
    ...
    title: {
        ...
        hi: "Spasmodic Dysphonia",
        gu: "Spasmodic Dysphonia",
        mr: "Spasmodic Dysphonia",
        es: "Spasmodic Dysphonia",
        ar: "Spasmodic Dysphonia"
    },
    summary: {
        en: "A comprehensive clinical overview of Spasmodic Dysphonia, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Spasmodic Dysphonia का नैदानिक विवरण.",
        gu: "Spasmodic Dysphonia નો તબીબી પરિચય.",
        mr: "Spasmodic Dysphonia चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Spasmodic Dysphonia.",
        ar: "نظرة عامة سريرية شاملة لـ Spasmodic Dysphonia."
    },
    content: {
        "overview": "Spasmodic dysphonia: Allergic and inflammatory respiratory tract conditions involve mucosal hypersensitivity, hyper-responsiveness, and chronic inflammatory cells. Care focuses on mucosal stabilization and reducing allergic hyper-reactivity.",
    ...
    tags: ["Spasmodic Dysphonia", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/spasmodic-dysphonia",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Spasmodic Dysphonia profile"]
};
