...
exports.PostViralFatigueDisease = void 0;
exports.PostViralFatigueDisease = {
    id: "D0068",
    ...
    title: {
        en: "Post-Viral Fatigue",
        hi: "Post-Viral Fatigue",
        gu: "Post-Viral Fatigue",
        mr: "Post-Viral Fatigue",
        es: "Post-Viral Fatigue",
        ar: "Post-Viral Fatigue"
    },
    summary: {
        en: "A comprehensive clinical overview of Post-Viral Fatigue, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Post-Viral Fatigue का नैदानिक विवरण.",
        gu: "Post-Viral Fatigue નો તબીબી પરિચય.",
        mr: "Post-Viral Fatigue चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Post-Viral Fatigue.",
        ar: "نظرة عامة سريرية شاملة لـ Post-Viral Fatigue."
    },
    content: {
        "overview": "Post viral fatigue: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
    ...
    tags: ["Post-Viral Fatigue", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/post-viral-fatigue",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Post-Viral Fatigue profile"]
};
