...
exports.DryEyeSyndromeDisease = void 0;
exports.DryEyeSyndromeDisease = {
    id: "D0064",
    ...
    summary: {
        en: "A comprehensive clinical overview of Dry Eye Syndrome, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Dry Eye Syndrome का नैदानिक विवरण.",
        gu: "Dry Eye Syndrome નો તબીબી પરિચય.",
        mr: "Dry Eye Syndrome चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Dry Eye Syndrome.",
        ar: "نظرة عامة سريرية شاملة لـ Dry Eye Syndrome."
    },
    content: {
        "overview": "Dry eye syndrome: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
    ...
    tags: ["Dry Eye Syndrome", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/dry-eye-syndrome",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Dry Eye Syndrome profile"]
};
