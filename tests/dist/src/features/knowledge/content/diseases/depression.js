...
exports.DepressionDisease = void 0;
exports.DepressionDisease = {
    id: "D0020",
    slug: "depression",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Depression, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Depression का नैदानिक विवरण.",
        gu: "Depression નો તબીબી પરિચય.",
        mr: "Depression चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Depression.",
        ar: "نظرة عامة سريرية شاملة لـ Depression."
    },
    content: {
        "overview": "Depression: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
    ...
    tags: ["Depression", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/depression",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Depression profile"]
};
