...
exports.ChronicCoughDisease = void 0;
exports.ChronicCoughDisease = {
    id: "D0054",
    slug: "chronic-cough",
    entityType: "disease",
    ...
    summary: {
        en: "A comprehensive clinical overview of Chronic Cough, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Chronic Cough का नैदानिक विवरण.",
        gu: "Chronic Cough નો તબીબી પરિચય.",
        mr: "Chronic Cough चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Chronic Cough.",
        ar: "نظرة عامة سريرية شاملة لـ Chronic Cough."
    },
    content: {
        "overview": "Chronic cough: Allergic and inflammatory respiratory tract conditions involve mucosal hypersensitivity, hyper-responsiveness, and chronic inflammatory cells. Care focuses on mucosal stabilization and reducing allergic hyper-reactivity.",
    ...
    tags: ["Chronic Cough", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/chronic-cough",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Chronic Cough profile"]
};
