...
exports.VitaminDDeficiencyDisease = void 0;
exports.VitaminDDeficiencyDisease = {
    id: "D0052",
    ...
    title: {
        ...
        gu: "Vitamin D Deficiency",
        mr: "Vitamin D Deficiency",
        es: "Vitamin D Deficiency",
        ar: "Vitamin D Deficiency"
    },
    summary: {
        en: "A comprehensive clinical overview of Vitamin D Deficiency, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Vitamin D Deficiency का नैदानिक विवरण.",
        gu: "Vitamin D Deficiency નો તબીબી પરિચય.",
        mr: "Vitamin D Deficiency चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Vitamin D Deficiency.",
        ar: "نظرة عامة سريرية شاملة لـ Vitamin D Deficiency."
    },
    content: {
        "overview": "Vitamin d deficiency: Systemic reactive patterns and chronic disease tendencies represent complex clinical entities that manifest across multiple organ systems. Management focuses on optimizing general vitality and addressing deep constitutional susceptibility.",
    ...
    tags: ["Vitamin D Deficiency", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/vitamin-d-deficiency",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Vitamin D Deficiency profile"]
};
