...
exports.PeripheralNeuropathyDisease = void 0;
exports.PeripheralNeuropathyDisease = {
    id: "D0070",
    ...
    title: {
        ...
        hi: "Peripheral Neuropathy",
        gu: "Peripheral Neuropathy",
        mr: "Peripheral Neuropathy",
        es: "Peripheral Neuropathy",
        ar: "Peripheral Neuropathy"
    },
    summary: {
        en: "A comprehensive clinical overview of Peripheral Neuropathy, covering causes, clinical symptoms, and homeopathic management principles.",
        hi: "Peripheral Neuropathy का नैदानिक विवरण.",
        gu: "Peripheral Neuropathy નો તબીબી પરિચય.",
        mr: "Peripheral Neuropathy चे आजार आणि माहिती.",
        es: "Un resumen clínico completo de Peripheral Neuropathy.",
        ar: "نظرة عامة سريرية شاملة لـ Peripheral Neuropathy."
    },
    content: {
        "overview": "Peripheral neuropathy: Neurological and musculoskeletal conditions affect physical mobility, postural alignment, and sensory nerve conductivity. Management focuses on biomechanical alignment, reducing localized neurogenic inflammation, and pain pathway modulation.",
    ...
    tags: ["Peripheral Neuropathy", "Disease", "Clinical-Overview"],
    canonicalUrl: "https://homeo.healthcare/knowledge/diseases/peripheral-neuropathy",
    readingTimeMinutes: 5,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Peripheral Neuropathy profile"]
};
