...
exports.ColocynthisRemedy = void 0;
exports.ColocynthisRemedy = {
    id: "R0036",
    slug: "colocynthis",
    entityType: "remedy",
    ...
    title: {
        en: "Colocynthis (Colocynthis Common)",
        hi: "Colocynthis",
        gu: "Colocynthis",
        mr: "Colocynthis",
        es: "Colocynthis",
    ...
    summary: {
        ...
        hi: "Colocynthis का होम्योपैथिक विवरण.",
        gu: "Colocynthis હોમિયોપેથિક દવા.",
        mr: "Colocynthis चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Colocynthis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy colocynthis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to colocynthis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of colocynthis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to colocynthis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Colocynthis", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/colocynthis",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Colocynthis remedy profile"]
};
