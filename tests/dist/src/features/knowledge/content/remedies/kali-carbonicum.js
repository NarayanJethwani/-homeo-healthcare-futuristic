...
exports.KaliCarbonicumRemedy = void 0;
exports.KaliCarbonicumRemedy = {
    id: "R0050",
    slug: "kali-carbonicum",
    entityType: "remedy",
    ...
    title: {
        en: "Kali Carbonicum (Kali Carbonicum Common)",
        hi: "Kali Carbonicum",
        gu: "Kali Carbonicum",
        mr: "Kali Carbonicum",
        es: "Kali Carbonicum",
    ...
    summary: {
        ...
        hi: "Kali Carbonicum का होम्योपैथिक विवरण.",
        gu: "Kali Carbonicum હોમિયોપેથિક દવા.",
        mr: "Kali Carbonicum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Kali carbonicum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy kali carbonicum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to kali carbonicum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of kali carbonicum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to kali carbonicum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Kali Carbonicum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/kali-carbonicum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Kali Carbonicum remedy profile"]
};
