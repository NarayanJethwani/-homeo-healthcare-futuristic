...
exports.AloeSocotrinaRemedy = void 0;
exports.AloeSocotrinaRemedy = {
    id: "R0081",
    slug: "aloe-socotrina",
    entityType: "remedy",
    ...
    title: {
        en: "Aloe Socotrina (Aloe Socotrina Common)",
        hi: "Aloe Socotrina",
        gu: "Aloe Socotrina",
        mr: "Aloe Socotrina",
        es: "Aloe Socotrina",
    ...
    summary: {
        ...
        hi: "Aloe Socotrina का होम्योपैथिक विवरण.",
        gu: "Aloe Socotrina હોમિયોપેથિક દવા.",
        mr: "Aloe Socotrina चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Aloe socotrina Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy aloe socotrina is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to aloe socotrina.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of aloe socotrina.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to aloe socotrina pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Aloe Socotrina", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/aloe-socotrina",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Aloe Socotrina remedy profile"]
};
