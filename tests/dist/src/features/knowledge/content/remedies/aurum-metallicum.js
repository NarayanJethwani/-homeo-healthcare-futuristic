...
exports.AurumMetallicumRemedy = void 0;
exports.AurumMetallicumRemedy = {
    id: "R0085",
    ...
    title: {
        en: "Aurum Metallicum (Aurum Metallicum Common)",
        hi: "Aurum Metallicum",
        gu: "Aurum Metallicum",
        mr: "Aurum Metallicum",
        es: "Aurum Metallicum",
    ...
    summary: {
        ...
        hi: "Aurum Metallicum का होम्योपैथिक विवरण.",
        gu: "Aurum Metallicum હોમિયોપેથિક દવા.",
        mr: "Aurum Metallicum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Aurum metallicum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy aurum metallicum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to aurum metallicum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of aurum metallicum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to aurum metallicum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Aurum Metallicum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/aurum-metallicum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Aurum Metallicum remedy profile"]
};
