...
exports.SepiaOfficinalisRemedy = void 0;
exports.SepiaOfficinalisRemedy = {
    id: "R0021",
    ...
    content: {
        ...
        "commonName": "Sepia officinalis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy sepia officinalis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to sepia officinalis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of sepia officinalis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to sepia officinalis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
