...
exports.VeratrumAlbumRemedy = void 0;
exports.VeratrumAlbumRemedy = {
    id: "R0078",
    slug: "veratrum-album",
    entityType: "remedy",
    ...
    title: {
        en: "Veratrum Album (Veratrum Album Common)",
        hi: "Veratrum Album",
        gu: "Veratrum Album",
        mr: "Veratrum Album",
        es: "Veratrum Album",
    ...
    summary: {
        ...
        hi: "Veratrum Album का होम्योपैथिक विवरण.",
        gu: "Veratrum Album હોમિયોપેથિક દવા.",
        mr: "Veratrum Album चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Veratrum album Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy veratrum album is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to veratrum album.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of veratrum album.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to veratrum album pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Veratrum Album", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/veratrum-album",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Veratrum Album remedy profile"]
};
