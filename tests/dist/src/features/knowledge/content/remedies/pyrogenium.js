...
exports.PyrogeniumRemedy = void 0;
exports.PyrogeniumRemedy = {
    id: "R0061",
    slug: "pyrogenium",
    entityType: "remedy",
    ...
    title: {
        en: "Pyrogenium (Pyrogenium Common)",
        hi: "Pyrogenium",
        gu: "Pyrogenium",
        mr: "Pyrogenium",
        es: "Pyrogenium",
    ...
    summary: {
        ...
        hi: "Pyrogenium का होम्योपैथिक विवरण.",
        gu: "Pyrogenium હોમિયોપેથિક દવા.",
        mr: "Pyrogenium चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Pyrogenium Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy pyrogenium is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to pyrogenium.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of pyrogenium.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to pyrogenium pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Pyrogenium", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/pyrogenium",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Pyrogenium remedy profile"]
};
