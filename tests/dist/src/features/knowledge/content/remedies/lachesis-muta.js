...
exports.LachesisMutaRemedy = void 0;
exports.LachesisMutaRemedy = {
    id: "R0053",
    slug: "lachesis-muta",
    entityType: "remedy",
    ...
    title: {
        en: "Lachesis Muta (Lachesis Muta Common)",
        hi: "Lachesis Muta",
        gu: "Lachesis Muta",
        mr: "Lachesis Muta",
        es: "Lachesis Muta",
    ...
    summary: {
        ...
        hi: "Lachesis Muta का होम्योपैथिक विवरण.",
        gu: "Lachesis Muta હોમિયોપેથિક દવા.",
        mr: "Lachesis Muta चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Lachesis muta Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy lachesis muta is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to lachesis muta.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of lachesis muta.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to lachesis muta pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Lachesis Muta", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/lachesis-muta",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Lachesis Muta remedy profile"]
};
