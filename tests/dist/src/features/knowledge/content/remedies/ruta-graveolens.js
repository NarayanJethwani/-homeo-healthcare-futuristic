...
exports.RutaGraveolensRemedy = void 0;
exports.RutaGraveolensRemedy = {
    id: "R0062",
    ...
    title: {
        en: "Ruta Graveolens (Ruta Graveolens Common)",
        hi: "Ruta Graveolens",
        gu: "Ruta Graveolens",
        mr: "Ruta Graveolens",
        es: "Ruta Graveolens",
    ...
    summary: {
        ...
        hi: "Ruta Graveolens का होम्योपैथिक विवरण.",
        gu: "Ruta Graveolens હોમિયોપેથિક દવા.",
        mr: "Ruta Graveolens चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Ruta graveolens Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy ruta graveolens is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to ruta graveolens.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of ruta graveolens.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to ruta graveolens pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Ruta Graveolens", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/ruta-graveolens",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Ruta Graveolens remedy profile"]
};
