...
exports.MagnesiaPhosphoricaRemedy = void 0;
exports.MagnesiaPhosphoricaRemedy = {
    id: "R0055",
    ...
    title: {
        en: "Magnesia Phosphorica (Magnesia Phosphorica Common)",
        hi: "Magnesia Phosphorica",
        gu: "Magnesia Phosphorica",
        mr: "Magnesia Phosphorica",
        es: "Magnesia Phosphorica",
        ar: "Magnesia Phosphorica"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Magnesia Phosphorica का होम्योपैथिक विवरण.",
        gu: "Magnesia Phosphorica હોમિયોપેથિક દવા.",
        mr: "Magnesia Phosphorica चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Magnesia Phosphorica",
        "commonName": "Magnesia phosphorica Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy magnesia phosphorica is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to magnesia phosphorica.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of magnesia phosphorica.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to magnesia phosphorica pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Magnesia Phosphorica", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/magnesia-phosphorica",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Magnesia Phosphorica remedy profile"]
};
