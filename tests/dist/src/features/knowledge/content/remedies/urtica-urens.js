...
exports.UrticaUrensRemedy = void 0;
exports.UrticaUrensRemedy = {
    id: "R0076",
    slug: "urtica-urens",
    entityType: "remedy",
    ...
    title: {
        en: "Urtica Urens (Urtica Urens Common)",
        hi: "Urtica Urens",
        gu: "Urtica Urens",
        mr: "Urtica Urens",
        es: "Urtica Urens",
    ...
    summary: {
        ...
        hi: "Urtica Urens का होम्योपैथिक विवरण.",
        gu: "Urtica Urens હોમિયોપેથિક દવા.",
        mr: "Urtica Urens चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Urtica urens Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy urtica urens is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to urtica urens.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of urtica urens.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to urtica urens pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Urtica Urens", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/urtica-urens",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Urtica Urens remedy profile"]
};
