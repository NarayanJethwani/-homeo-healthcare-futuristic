...
exports.PhosphorusRemedy = void 0;
exports.PhosphorusRemedy = {
    id: "R0018",
    slug: "phosphorus",
    entityType: "remedy",
    ...
    content: {
        ...
        "commonName": "Phosphorus Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy phosphorus is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to phosphorus.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of phosphorus.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to phosphorus pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
