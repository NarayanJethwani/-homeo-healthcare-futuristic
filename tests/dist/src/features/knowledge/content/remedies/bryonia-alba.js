...
exports.BryoniaAlbaRemedy = void 0;
exports.BryoniaAlbaRemedy = {
    id: "R0008",
    slug: "bryonia-alba",
    entityType: "remedy",
    ...
    content: {
        ...
        "commonName": "Bryonia alba Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy bryonia alba is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to bryonia alba.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of bryonia alba.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to bryonia alba pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
