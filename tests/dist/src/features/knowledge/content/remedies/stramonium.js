...
exports.StramoniumRemedy = void 0;
exports.StramoniumRemedy = {
    id: "R0071",
    slug: "stramonium",
    entityType: "remedy",
    ...
    title: {
        en: "Stramonium (Stramonium Common)",
        hi: "Stramonium",
        gu: "Stramonium",
        mr: "Stramonium",
        es: "Stramonium",
    ...
    summary: {
        ...
        hi: "Stramonium का होम्योपैथिक विवरण.",
        gu: "Stramonium હોમિયોપેથિક દવા.",
        mr: "Stramonium चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Stramonium Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy stramonium is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to stramonium.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of stramonium.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to stramonium pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Stramonium", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/stramonium",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Stramonium remedy profile"]
};
