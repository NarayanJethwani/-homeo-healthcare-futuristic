...
exports.AnacardiumRemedy = void 0;
exports.AnacardiumRemedy = {
    id: "R0082",
    slug: "anacardium",
    entityType: "remedy",
    ...
    title: {
        en: "Anacardium (Anacardium Common)",
        hi: "Anacardium",
        gu: "Anacardium",
        mr: "Anacardium",
        es: "Anacardium",
    ...
    summary: {
        ...
        hi: "Anacardium का होम्योपैथिक विवरण.",
        gu: "Anacardium હોમિયોપેથિક દવા.",
        mr: "Anacardium चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Anacardium",
        "commonName": "Anacardium Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy anacardium is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to anacardium.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of anacardium.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to anacardium pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Anacardium", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/anacardium",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Anacardium remedy profile"]
};
