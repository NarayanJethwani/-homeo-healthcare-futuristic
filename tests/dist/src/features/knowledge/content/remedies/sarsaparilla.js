...
exports.SarsaparillaRemedy = void 0;
exports.SarsaparillaRemedy = {
    id: "R0066",
    slug: "sarsaparilla",
    entityType: "remedy",
    ...
    title: {
        en: "Sarsaparilla (Sarsaparilla Common)",
        hi: "Sarsaparilla",
        gu: "Sarsaparilla",
        mr: "Sarsaparilla",
        es: "Sarsaparilla",
    ...
    summary: {
        ...
        hi: "Sarsaparilla का होम्योपैथिक विवरण.",
        gu: "Sarsaparilla હોમિયોપેથિક દવા.",
        mr: "Sarsaparilla चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Sarsaparilla Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy sarsaparilla is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to sarsaparilla.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of sarsaparilla.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to sarsaparilla pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Sarsaparilla", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/sarsaparilla",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Sarsaparilla remedy profile"]
};
