...
exports.SiliceaTerraRemedy = void 0;
exports.SiliceaTerraRemedy = {
    id: "R0022",
    slug: "silicea-terra",
    entityType: "remedy",
    ...
    content: {
        ...
        "commonName": "Silicea terra Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy silicea terra is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to silicea terra.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of silicea terra.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to silicea terra pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
