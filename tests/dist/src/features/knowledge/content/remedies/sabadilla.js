...
exports.SabadillaRemedy = void 0;
exports.SabadillaRemedy = {
    id: "R0063",
    slug: "sabadilla",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Sabadilla का होम्योपैथिक विवरण.",
        gu: "Sabadilla હોમિયોપેથિક દવા.",
        mr: "Sabadilla चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Sabadilla",
        "commonName": "Sabadilla Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy sabadilla is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to sabadilla.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of sabadilla.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to sabadilla pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Sabadilla", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/sabadilla",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Sabadilla remedy profile"]
};
