...
exports.BaptisiaTinctoriaRemedy = void 0;
exports.BaptisiaTinctoriaRemedy = {
    id: "R0028",
    ...
    title: {
        en: "Baptisia Tinctoria (Baptisia Tinctoria Common)",
        hi: "Baptisia Tinctoria",
        gu: "Baptisia Tinctoria",
        mr: "Baptisia Tinctoria",
        es: "Baptisia Tinctoria",
        ar: "Baptisia Tinctoria"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Baptisia Tinctoria का होम्योपैथिक विवरण.",
        gu: "Baptisia Tinctoria હોમિયોપેથિક દવા.",
        mr: "Baptisia Tinctoria चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Baptisia tinctoria Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy baptisia tinctoria is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to baptisia tinctoria.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of baptisia tinctoria.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to baptisia tinctoria pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Baptisia Tinctoria", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/baptisia-tinctoria",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Baptisia Tinctoria remedy profile"]
};
