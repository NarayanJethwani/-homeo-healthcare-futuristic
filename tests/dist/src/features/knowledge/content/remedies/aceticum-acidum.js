...
exports.AceticumAcidumRemedy = void 0;
exports.AceticumAcidumRemedy = {
    id: "R0107",
    slug: "aceticum-acidum",
    entityType: "remedy",
    ...
    title: {
        en: "Aceticum Acidum (Glacial Acetic Acid)",
        hi: "Aceticum Acidum",
        gu: "Aceticum Acidum",
        mr: "Aceticum Acidum",
        es: "Aceticum Acidum",
    ...
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Blood and Mucous Membranes.",
        hi: "Aceticum Acidum का होम्योपैथिक विवरण.",
        gu: "Aceticum Acidum હોમિયોપેથિક દવા.",
        mr: "Aceticum Acidum चे होमिओपॅथी माहिती.",
        es: "Un remedio homeopático clave con afinidad clínica para Blood y Mucous Membranes.",
        ar: "علاج مثلي هام ذو تقارب سريري لـ Blood و Mucous Membranes."
    },
    content: {
        "latinName": "Aceticum Acidum",
        "commonName": "Aceticum acidum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy aceticum acidum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to aceticum acidum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of aceticum acidum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to aceticum acidum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Aceticum Acidum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/aceticum-acidum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Aceticum Acidum remedy profile"]
};
