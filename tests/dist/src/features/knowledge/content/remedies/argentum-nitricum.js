...
exports.ArgentumNitricumRemedy = void 0;
exports.ArgentumNitricumRemedy = {
    id: "R0027",
    ...
    title: {
        en: "Argentum Nitricum (Argentum Nitricum Common)",
        hi: "Argentum Nitricum",
        gu: "Argentum Nitricum",
        mr: "Argentum Nitricum",
        es: "Argentum Nitricum",
        ar: "Argentum Nitricum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Argentum Nitricum का होम्योपैथिक विवरण.",
        gu: "Argentum Nitricum હોમિયોપેથિક દવા.",
        mr: "Argentum Nitricum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Argentum nitricum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy argentum nitricum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to argentum nitricum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of argentum nitricum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to argentum nitricum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Argentum Nitricum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/argentum-nitricum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Argentum Nitricum remedy profile"]
};
