...
exports.KreosotumRemedy = void 0;
exports.KreosotumRemedy = {
    id: "R0052",
    slug: "kreosotum",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Kreosotum का होम्योपैथिक विवरण.",
        gu: "Kreosotum હોમિયોપેથિક દવા.",
        mr: "Kreosotum चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Kreosotum",
        "commonName": "Kreosotum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy kreosotum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to kreosotum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of kreosotum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to kreosotum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Kreosotum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/kreosotum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Kreosotum remedy profile"]
};
