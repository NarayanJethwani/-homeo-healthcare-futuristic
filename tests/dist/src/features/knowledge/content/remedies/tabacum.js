...
exports.TabacumRemedy = void 0;
exports.TabacumRemedy = {
    id: "R0074",
    slug: "tabacum",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Tabacum का होम्योपैथिक विवरण.",
        gu: "Tabacum હોમિયોપેથિક દવા.",
        mr: "Tabacum चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Tabacum",
        "commonName": "Tabacum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy tabacum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to tabacum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of tabacum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to tabacum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Tabacum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/tabacum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Tabacum remedy profile"]
};
