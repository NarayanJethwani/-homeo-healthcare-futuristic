...
exports.CaladiumRemedy = void 0;
exports.CaladiumRemedy = {
    id: "R0090",
    slug: "caladium",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Caladium का होम्योपैथिक विवरण.",
        gu: "Caladium હોમિયોપેથિક દવા.",
        mr: "Caladium चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Caladium",
        "commonName": "Caladium Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy caladium is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to caladium.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of caladium.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to caladium pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Caladium", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/caladium",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Caladium remedy profile"]
};
