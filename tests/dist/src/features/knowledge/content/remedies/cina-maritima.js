...
exports.CinaMaritimaRemedy = void 0;
exports.CinaMaritimaRemedy = {
    id: "R0034",
    slug: "cina-maritima",
    entityType: "remedy",
    ...
    title: {
        en: "Cina Maritima (Cina Maritima Common)",
        hi: "Cina Maritima",
        gu: "Cina Maritima",
        mr: "Cina Maritima",
        es: "Cina Maritima",
    ...
    summary: {
        ...
        hi: "Cina Maritima का होम्योपैथिक विवरण.",
        gu: "Cina Maritima હોમિયોપેથિક દવા.",
        mr: "Cina Maritima चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Cina Maritima",
        "commonName": "Cina maritima Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy cina maritima is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to cina maritima.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of cina maritima.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to cina maritima pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Cina Maritima", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/cina-maritima",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Cina Maritima remedy profile"]
};
