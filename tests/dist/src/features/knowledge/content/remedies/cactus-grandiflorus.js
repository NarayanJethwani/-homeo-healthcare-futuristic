...
exports.CactusGrandiflorusRemedy = void 0;
exports.CactusGrandiflorusRemedy = {
    id: "R0031",
    ...
    title: {
        en: "Cactus Grandiflorus (Cactus Grandiflorus Common)",
        hi: "Cactus Grandiflorus",
        gu: "Cactus Grandiflorus",
        mr: "Cactus Grandiflorus",
        es: "Cactus Grandiflorus",
        ar: "Cactus Grandiflorus"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Cactus Grandiflorus का होम्योपैथिक विवरण.",
        gu: "Cactus Grandiflorus હોમિયોપેથિક દવા.",
        mr: "Cactus Grandiflorus चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Cactus grandiflorus Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy cactus grandiflorus is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to cactus grandiflorus.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of cactus grandiflorus.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to cactus grandiflorus pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Cactus Grandiflorus", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/cactus-grandiflorus",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Cactus Grandiflorus remedy profile"]
};
