...
exports.CinchonaOfficinalisRemedy = void 0;
exports.CinchonaOfficinalisRemedy = {
    id: "R0035",
    ...
    title: {
        en: "Cinchona Officinalis (Cinchona Officinalis Common)",
        hi: "Cinchona Officinalis",
        gu: "Cinchona Officinalis",
        mr: "Cinchona Officinalis",
        es: "Cinchona Officinalis",
        ar: "Cinchona Officinalis"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Cinchona Officinalis का होम्योपैथिक विवरण.",
        gu: "Cinchona Officinalis હોમિયોપેથિક દવા.",
        mr: "Cinchona Officinalis चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Cinchona officinalis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy cinchona officinalis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to cinchona officinalis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of cinchona officinalis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to cinchona officinalis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Cinchona Officinalis", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/cinchona-officinalis",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Cinchona Officinalis remedy profile"]
};
