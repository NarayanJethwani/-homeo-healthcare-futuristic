...
exports.RhusToxicodendronRemedy = void 0;
exports.RhusToxicodendronRemedy = {
    id: "R0020",
    ...
    content: {
        ...
        "commonName": "Rhus toxicodendron Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy rhus toxicodendron is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to rhus toxicodendron.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of rhus toxicodendron.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to rhus toxicodendron pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
