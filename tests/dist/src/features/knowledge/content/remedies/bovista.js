...
exports.BovistaRemedy = void 0;
exports.BovistaRemedy = {
    id: "R0089",
    slug: "bovista",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Bovista का होम्योपैथिक विवरण.",
        gu: "Bovista હોમિયોપેથિક દવા.",
        mr: "Bovista चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Bovista",
        "commonName": "Bovista Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy bovista is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to bovista.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of bovista.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to bovista pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Bovista", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/bovista",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Bovista remedy profile"]
};
