...
exports.CantharisRemedy = void 0;
exports.CantharisRemedy = {
    id: "R0032",
    slug: "cantharis",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Cantharis का होम्योपैथिक विवरण.",
        gu: "Cantharis હોમિયોપેથિક દવા.",
        mr: "Cantharis चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Cantharis",
        "commonName": "Cantharis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy cantharis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to cantharis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of cantharis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to cantharis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Cantharis", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/cantharis",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Cantharis remedy profile"]
};
