...
exports.AesculusHippocastanumRemedy = void 0;
exports.AesculusHippocastanumRemedy = {
    id: "R0080",
    ...
    title: {
        en: "Aesculus Hippocastanum (Aesculus Hippocastanum Common)",
        hi: "Aesculus Hippocastanum",
        gu: "Aesculus Hippocastanum",
        mr: "Aesculus Hippocastanum",
        es: "Aesculus Hippocastanum",
        ar: "Aesculus Hippocastanum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Aesculus Hippocastanum का होम्योपैथिक विवरण.",
        gu: "Aesculus Hippocastanum હોમિયોપેથિક દવા.",
        mr: "Aesculus Hippocastanum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Aesculus hippocastanum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy aesculus hippocastanum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to aesculus hippocastanum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of aesculus hippocastanum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to aesculus hippocastanum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Aesculus Hippocastanum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/aesculus-hippocastanum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Aesculus Hippocastanum remedy profile"]
};
