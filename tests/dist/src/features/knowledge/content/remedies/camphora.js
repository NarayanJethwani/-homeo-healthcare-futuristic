...
exports.CamphoraRemedy = void 0;
exports.CamphoraRemedy = {
    id: "R0094",
    slug: "camphora",
    entityType: "remedy",
    ...
    content: {
        ...
        "description": "The remedy camphora is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to camphora.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of camphora.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to camphora pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
