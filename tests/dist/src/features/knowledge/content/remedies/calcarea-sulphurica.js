...
exports.CalcareaSulphuricaRemedy = void 0;
exports.CalcareaSulphuricaRemedy = {
    id: "R0093",
    slug: "calcarea-sulphurica",
    entityType: "remedy",
    ...
    title: {
        en: "Calcarea Sulphurica (Calcarea Sulphurica Common)",
        hi: "Calcarea Sulphurica",
        gu: "Calcarea Sulphurica",
        mr: "Calcarea Sulphurica",
        es: "Calcarea Sulphurica",
        ar: "Calcarea Sulphurica"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Calcarea Sulphurica का होम्योपैथिक विवरण.",
        gu: "Calcarea Sulphurica હોમિયોપેથિક દવા.",
        mr: "Calcarea Sulphurica चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Calcarea Sulphurica",
        "commonName": "Calcarea sulphurica Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy calcarea sulphurica is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to calcarea sulphurica.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of calcarea sulphurica.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to calcarea sulphurica pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Calcarea Sulphurica", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/calcarea-sulphurica",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Calcarea Sulphurica remedy profile"]
};
