...
exports.CarboAnimalisRemedy = void 0;
exports.CarboAnimalisRemedy = {
    id: "R0137",
    slug: "carbo-animalis",
    entityType: "remedy",
    ...
    title: {
        en: "Carbo Animalis (Animal Charcoal)",
        hi: "Carbo Animalis",
        gu: "Carbo Animalis",
        mr: "Carbo Animalis",
        es: "Carbo Animalis",
    ...
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Glands and Veins and Stomach.",
        hi: "Carbo Animalis का होम्योपैथिक विवरण.",
        gu: "Carbo Animalis હોમિયોપેથિક દવા.",
        mr: "Carbo Animalis चे होमिओपॅथी माहिती.",
        es: "Un remedio homeopático clave con afinidad clínica para Glands y Veins y Stomach.",
        ar: "علاج مثلي هام ذو تقارب سريري لـ Glands و Veins و Stomach."
    },
    content: {
        "latinName": "Carbo Animalis",
        "commonName": "Carbo animalis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy carbo animalis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to carbo animalis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of carbo animalis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to carbo animalis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Carbo Animalis", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/carbo-animalis",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Carbo Animalis remedy profile"]
};
