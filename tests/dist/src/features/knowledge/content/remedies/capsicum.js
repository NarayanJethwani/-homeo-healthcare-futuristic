...
exports.CapsicumRemedy = void 0;
exports.CapsicumRemedy = {
    id: "R0097",
    slug: "capsicum",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Capsicum का होम्योपैथिक विवरण.",
        gu: "Capsicum હોમિયોપેથિક દવા.",
        mr: "Capsicum चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Capsicum",
        "commonName": "Capsicum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy capsicum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to capsicum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of capsicum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to capsicum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Capsicum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/capsicum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Capsicum remedy profile"]
};
