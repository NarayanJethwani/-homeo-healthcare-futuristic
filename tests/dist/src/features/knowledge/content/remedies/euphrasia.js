...
exports.EuphrasiaRemedy = void 0;
exports.EuphrasiaRemedy = {
    id: "R0042",
    slug: "euphrasia",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Euphrasia का होम्योपैथिक विवरण.",
        gu: "Euphrasia હોમિયોપેથિક દવા.",
        mr: "Euphrasia चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Euphrasia",
        "commonName": "Euphrasia Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy euphrasia is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to euphrasia.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of euphrasia.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to euphrasia pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Euphrasia", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/euphrasia",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Euphrasia remedy profile"]
};
