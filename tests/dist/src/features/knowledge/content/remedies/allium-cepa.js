...
exports.AlliumCepaRemedy = void 0;
exports.AlliumCepaRemedy = {
    id: "R0024",
    slug: "allium-cepa",
    entityType: "remedy",
    ...
    title: {
        en: "Allium Cepa (Allium Cepa Common)",
        hi: "Allium Cepa",
        gu: "Allium Cepa",
        mr: "Allium Cepa",
        es: "Allium Cepa",
    ...
    summary: {
        ...
        hi: "Allium Cepa का होम्योपैथिक विवरण.",
        gu: "Allium Cepa હોમિયોપેથિક દવા.",
        mr: "Allium Cepa चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Allium cepa Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy allium cepa is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to allium cepa.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of allium cepa.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to allium cepa pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Allium Cepa", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/allium-cepa",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Allium Cepa remedy profile"]
};
