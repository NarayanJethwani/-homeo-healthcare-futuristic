...
exports.LedumPalustreRemedy = void 0;
exports.LedumPalustreRemedy = {
    id: "R0054",
    slug: "ledum-palustre",
    entityType: "remedy",
    ...
    title: {
        en: "Ledum Palustre (Ledum Palustre Common)",
        hi: "Ledum Palustre",
        gu: "Ledum Palustre",
        mr: "Ledum Palustre",
        es: "Ledum Palustre",
    ...
    summary: {
        ...
        hi: "Ledum Palustre का होम्योपैथिक विवरण.",
        gu: "Ledum Palustre હોમિયોપેથિક દવા.",
        mr: "Ledum Palustre चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Ledum palustre Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy ledum palustre is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to ledum palustre.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of ledum palustre.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to ledum palustre pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Ledum Palustre", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/ledum-palustre",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Ledum Palustre remedy profile"]
};
