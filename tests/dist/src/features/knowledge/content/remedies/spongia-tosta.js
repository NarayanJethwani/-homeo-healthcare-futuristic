...
exports.SpongiaTostaRemedy = void 0;
exports.SpongiaTostaRemedy = {
    id: "R0069",
    slug: "spongia-tosta",
    entityType: "remedy",
    ...
    title: {
        en: "Spongia Tosta (Spongia Tosta Common)",
        hi: "Spongia Tosta",
        gu: "Spongia Tosta",
        mr: "Spongia Tosta",
        es: "Spongia Tosta",
    ...
    summary: {
        ...
        hi: "Spongia Tosta का होम्योपैथिक विवरण.",
        gu: "Spongia Tosta હોમિયોપેથિક દવા.",
        mr: "Spongia Tosta चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Spongia tosta Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy spongia tosta is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to spongia tosta.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of spongia tosta.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to spongia tosta pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Spongia Tosta", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/spongia-tosta",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Spongia Tosta remedy profile"]
};
