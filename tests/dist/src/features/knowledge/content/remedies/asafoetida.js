...
exports.AsafoetidaRemedy = void 0;
exports.AsafoetidaRemedy = {
    id: "R0084",
    slug: "asafoetida",
    entityType: "remedy",
    ...
    content: {
        ...
        "description": "The remedy asafoetida is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to asafoetida.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of asafoetida.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to asafoetida pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
