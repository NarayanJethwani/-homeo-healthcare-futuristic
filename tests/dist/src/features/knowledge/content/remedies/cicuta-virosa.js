...
exports.CicutaVirosaRemedy = void 0;
exports.CicutaVirosaRemedy = {
    id: "R0099",
    slug: "cicuta-virosa",
    entityType: "remedy",
    ...
    title: {
        en: "Cicuta Virosa (Cicuta Virosa Common)",
        hi: "Cicuta Virosa",
        gu: "Cicuta Virosa",
        mr: "Cicuta Virosa",
        es: "Cicuta Virosa",
    ...
    summary: {
        ...
        hi: "Cicuta Virosa का होम्योपैथिक विवरण.",
        gu: "Cicuta Virosa હોમિયોપેથિક દવા.",
        mr: "Cicuta Virosa चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Cicuta virosa Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy cicuta virosa is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to cicuta virosa.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of cicuta virosa.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to cicuta virosa pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Cicuta Virosa", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/cicuta-virosa",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Cicuta Virosa remedy profile"]
};
