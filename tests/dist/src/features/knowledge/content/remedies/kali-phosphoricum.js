...
exports.KaliPhosphoricumRemedy = void 0;
exports.KaliPhosphoricumRemedy = {
    id: "R0051",
    ...
    title: {
        en: "Kali Phosphoricum (Kali Phosphoricum Common)",
        hi: "Kali Phosphoricum",
        gu: "Kali Phosphoricum",
        mr: "Kali Phosphoricum",
        es: "Kali Phosphoricum",
        ar: "Kali Phosphoricum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Kali Phosphoricum का होम्योपैथिक विवरण.",
        gu: "Kali Phosphoricum હોમિયોપેથિક દવા.",
        mr: "Kali Phosphoricum चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Kali Phosphoricum",
        "commonName": "Kali phosphoricum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy kali phosphoricum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to kali phosphoricum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of kali phosphoricum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to kali phosphoricum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Kali Phosphoricum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/kali-phosphoricum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Kali Phosphoricum remedy profile"]
};
