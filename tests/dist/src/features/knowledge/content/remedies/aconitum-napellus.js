...
exports.AconitumNapellusRemedy = void 0;
exports.AconitumNapellusRemedy = {
    id: "R0004",
    ...
    content: {
        ...
        "commonName": "Aconitum napellus Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy aconitum napellus is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to aconitum napellus.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of aconitum napellus.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to aconitum napellus pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
