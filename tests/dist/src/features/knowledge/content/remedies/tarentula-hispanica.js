...
exports.TarentulaHispanicaRemedy = void 0;
exports.TarentulaHispanicaRemedy = {
    id: "R0075",
    ...
    title: {
        en: "Tarentula Hispanica (Tarentula Hispanica Common)",
        hi: "Tarentula Hispanica",
        gu: "Tarentula Hispanica",
        mr: "Tarentula Hispanica",
        es: "Tarentula Hispanica",
        ar: "Tarentula Hispanica"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Tarentula Hispanica का होम्योपैथिक विवरण.",
        gu: "Tarentula Hispanica હોમિયોપેથિક દવા.",
        mr: "Tarentula Hispanica चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Tarentula hispanica Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy tarentula hispanica is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to tarentula hispanica.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of tarentula hispanica.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to tarentula hispanica pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Tarentula Hispanica", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/tarentula-hispanica",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Tarentula Hispanica remedy profile"]
};
