...
exports.CalcareaFluoricaRemedy = void 0;
exports.CalcareaFluoricaRemedy = {
    id: "R0091",
    ...
    title: {
        en: "Calcarea Fluorica (Calcarea Fluorica Common)",
        hi: "Calcarea Fluorica",
        gu: "Calcarea Fluorica",
        mr: "Calcarea Fluorica",
        es: "Calcarea Fluorica",
        ar: "Calcarea Fluorica"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Calcarea Fluorica का होम्योपैथिक विवरण.",
        gu: "Calcarea Fluorica હોમિયોપેથિક દવા.",
        mr: "Calcarea Fluorica चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Calcarea fluorica Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy calcarea fluorica is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to calcarea fluorica.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of calcarea fluorica.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to calcarea fluorica pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Calcarea Fluorica", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/calcarea-fluorica",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Calcarea Fluorica remedy profile"]
};
