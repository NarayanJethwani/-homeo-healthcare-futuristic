...
exports.AntimoniumTartaricumRemedy = void 0;
exports.AntimoniumTartaricumRemedy = {
    id: "R0025",
    ...
    title: {
        en: "Antimonium Tartaricum (Antimonium Tartaricum Common)",
        hi: "Antimonium Tartaricum",
        gu: "Antimonium Tartaricum",
        mr: "Antimonium Tartaricum",
        es: "Antimonium Tartaricum",
        ar: "Antimonium Tartaricum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Antimonium Tartaricum का होम्योपैथिक विवरण.",
        gu: "Antimonium Tartaricum હોમિયોપેથિક દવા.",
        mr: "Antimonium Tartaricum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Antimonium tartaricum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy antimonium tartaricum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to antimonium tartaricum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of antimonium tartaricum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to antimonium tartaricum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Antimonium Tartaricum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/antimonium-tartaricum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Antimonium Tartaricum remedy profile"]
};
