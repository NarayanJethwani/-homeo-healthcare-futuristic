...
exports.ValerianaRemedy = void 0;
exports.ValerianaRemedy = {
    id: "R0077",
    slug: "valeriana",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Valeriana का होम्योपैथिक विवरण.",
        gu: "Valeriana હોમિયોપેથિક દવા.",
        mr: "Valeriana चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Valeriana",
        "commonName": "Valeriana Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy valeriana is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to valeriana.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of valeriana.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to valeriana pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Valeriana", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/valeriana",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Valeriana remedy profile"]
};
