...
exports.PhytolaccaRemedy = void 0;
exports.PhytolaccaRemedy = {
    id: "R0058",
    slug: "phytolacca",
    entityType: "remedy",
    ...
    title: {
        en: "Phytolacca (Phytolacca Common)",
        hi: "Phytolacca",
        gu: "Phytolacca",
        mr: "Phytolacca",
        es: "Phytolacca",
    ...
    summary: {
        ...
        hi: "Phytolacca का होम्योपैथिक विवरण.",
        gu: "Phytolacca હોમિયોપેથિક દવા.",
        mr: "Phytolacca चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Phytolacca",
        "commonName": "Phytolacca Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy phytolacca is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to phytolacca.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of phytolacca.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to phytolacca pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Phytolacca", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/phytolacca",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Phytolacca remedy profile"]
};
