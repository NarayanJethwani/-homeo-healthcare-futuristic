...
exports.PlumbumMetallicumRemedy = void 0;
exports.PlumbumMetallicumRemedy = {
    id: "R0059",
    ...
    content: {
        ...
        "description": "The remedy plumbum metallicum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to plumbum metallicum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of plumbum metallicum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to plumbum metallicum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
