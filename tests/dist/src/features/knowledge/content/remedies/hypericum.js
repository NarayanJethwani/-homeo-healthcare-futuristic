...
exports.HypericumRemedy = void 0;
exports.HypericumRemedy = {
    id: "R0048",
    slug: "hypericum",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Hypericum का होम्योपैथिक विवरण.",
        gu: "Hypericum હોમિયોપેથિક દવા.",
        mr: "Hypericum चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Hypericum",
        "commonName": "Hypericum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy hypericum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to hypericum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of hypericum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to hypericum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Hypericum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/hypericum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Hypericum remedy profile"]
};
