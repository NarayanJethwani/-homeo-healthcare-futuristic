...
exports.BenzoinRemedy = void 0;
exports.BenzoinRemedy = {
    id: "R0087",
    slug: "benzoin",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Benzoin का होम्योपैथिक विवरण.",
        gu: "Benzoin હોમિયોપેથિક દવા.",
        mr: "Benzoin चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Benzoin",
        "commonName": "Benzoin Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy benzoin is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to benzoin.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of benzoin.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to benzoin pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Benzoin", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/benzoin",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Benzoin remedy profile"]
};
