...
exports.FerrumPhosphoricumRemedy = void 0;
exports.FerrumPhosphoricumRemedy = {
    id: "R0043",
    ...
    title: {
        en: "Ferrum Phosphoricum (Ferrum Phosphoricum Common)",
        hi: "Ferrum Phosphoricum",
        gu: "Ferrum Phosphoricum",
        mr: "Ferrum Phosphoricum",
        es: "Ferrum Phosphoricum",
        ar: "Ferrum Phosphoricum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Ferrum Phosphoricum का होम्योपैथिक विवरण.",
        gu: "Ferrum Phosphoricum હોમિયોપેથિક દવા.",
        mr: "Ferrum Phosphoricum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Ferrum phosphoricum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy ferrum phosphoricum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to ferrum phosphoricum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of ferrum phosphoricum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to ferrum phosphoricum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Ferrum Phosphoricum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/ferrum-phosphoricum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Ferrum Phosphoricum remedy profile"]
};
