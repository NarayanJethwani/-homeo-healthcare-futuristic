...
exports.DigitalisRemedy = void 0;
exports.DigitalisRemedy = {
    id: "R0038",
    slug: "digitalis",
    entityType: "remedy",
    ...
    content: {
        ...
        "description": "The remedy digitalis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to digitalis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of digitalis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to digitalis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
