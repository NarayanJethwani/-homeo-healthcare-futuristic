...
exports.SanguinariaRemedy = void 0;
exports.SanguinariaRemedy = {
    id: "R0065",
    slug: "sanguinaria",
    entityType: "remedy",
    ...
    title: {
        en: "Sanguinaria (Sanguinaria Common)",
        hi: "Sanguinaria",
        gu: "Sanguinaria",
        mr: "Sanguinaria",
        es: "Sanguinaria",
    ...
    summary: {
        ...
        hi: "Sanguinaria का होम्योपैथिक विवरण.",
        gu: "Sanguinaria હોમિયોપેથિક દવા.",
        mr: "Sanguinaria चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Sanguinaria",
        "commonName": "Sanguinaria Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy sanguinaria is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to sanguinaria.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of sanguinaria.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to sanguinaria pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Sanguinaria", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/sanguinaria",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Sanguinaria remedy profile"]
};
