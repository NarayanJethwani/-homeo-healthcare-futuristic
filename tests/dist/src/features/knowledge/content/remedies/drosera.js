...
exports.DroseraRemedy = void 0;
exports.DroseraRemedy = {
    id: "R0039",
    slug: "drosera",
    entityType: "remedy",
    ...
    content: {
        ...
        "description": "The remedy drosera is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to drosera.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of drosera.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to drosera pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
