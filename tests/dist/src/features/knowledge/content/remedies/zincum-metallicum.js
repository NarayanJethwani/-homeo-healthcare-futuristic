...
exports.ZincumMetallicumRemedy = void 0;
exports.ZincumMetallicumRemedy = {
    id: "R0079",
    ...
    title: {
        en: "Zincum Metallicum (Zincum Metallicum Common)",
        hi: "Zincum Metallicum",
        gu: "Zincum Metallicum",
        mr: "Zincum Metallicum",
        es: "Zincum Metallicum",
        ar: "Zincum Metallicum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Zincum Metallicum का होम्योपैथिक विवरण.",
        gu: "Zincum Metallicum હોમિયોપેથિક દવા.",
        mr: "Zincum Metallicum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Zincum metallicum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy zincum metallicum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to zincum metallicum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of zincum metallicum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to zincum metallicum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Zincum Metallicum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/zincum-metallicum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Zincum Metallicum remedy profile"]
};
