...
exports.CalcareaPhosphoricaRemedy = void 0;
exports.CalcareaPhosphoricaRemedy = {
    id: "R0092",
    ...
    title: {
        en: "Calcarea Phosphorica (Calcarea Phosphorica Common)",
        hi: "Calcarea Phosphorica",
        gu: "Calcarea Phosphorica",
        mr: "Calcarea Phosphorica",
        es: "Calcarea Phosphorica",
        ar: "Calcarea Phosphorica"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Calcarea Phosphorica का होम्योपैथिक विवरण.",
        gu: "Calcarea Phosphorica હોમિયોપેથિક દવા.",
        mr: "Calcarea Phosphorica चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Calcarea phosphorica Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy calcarea phosphorica is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to calcarea phosphorica.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of calcarea phosphorica.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to calcarea phosphorica pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Calcarea Phosphorica", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/calcarea-phosphorica",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Calcarea Phosphorica remedy profile"]
};
