...
exports.EupatoriumPerfoliatumRemedy = void 0;
exports.EupatoriumPerfoliatumRemedy = {
    id: "R0041",
    ...
    title: {
        en: "Eupatorium Perfoliatum (Eupatorium Perfoliatum Common)",
        hi: "Eupatorium Perfoliatum",
        gu: "Eupatorium Perfoliatum",
        mr: "Eupatorium Perfoliatum",
        es: "Eupatorium Perfoliatum",
        ar: "Eupatorium Perfoliatum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Eupatorium Perfoliatum का होम्योपैथिक विवरण.",
        gu: "Eupatorium Perfoliatum હોમિયોપેથિક દવા.",
        mr: "Eupatorium Perfoliatum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Eupatorium perfoliatum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy eupatorium perfoliatum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to eupatorium perfoliatum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of eupatorium perfoliatum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to eupatorium perfoliatum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Eupatorium Perfoliatum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/eupatorium-perfoliatum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Eupatorium Perfoliatum remedy profile"]
};
