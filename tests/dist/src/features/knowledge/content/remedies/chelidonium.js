...
exports.ChelidoniumRemedy = void 0;
exports.ChelidoniumRemedy = {
    id: "R0098",
    slug: "chelidonium",
    entityType: "remedy",
    ...
    title: {
        en: "Chelidonium (Chelidonium Common)",
        hi: "Chelidonium",
        gu: "Chelidonium",
        mr: "Chelidonium",
        es: "Chelidonium",
    ...
    summary: {
        ...
        hi: "Chelidonium का होम्योपैथिक विवरण.",
        gu: "Chelidonium હોમિયોપેથિક દવા.",
        mr: "Chelidonium चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Chelidonium",
        "commonName": "Chelidonium Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy chelidonium is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to chelidonium.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of chelidonium.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to chelidonium pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Chelidonium", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/chelidonium",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Chelidonium remedy profile"]
};
