...
exports.ConiumMaculatumRemedy = void 0;
exports.ConiumMaculatumRemedy = {
    id: "R0037",
    ...
    content: {
        ...
        "description": "The remedy conium maculatum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to conium maculatum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of conium maculatum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to conium maculatum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
