...
exports.ClematisRemedy = void 0;
exports.ClematisRemedy = {
    id: "R0100",
    slug: "clematis",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Clematis का होम्योपैथिक विवरण.",
        gu: "Clematis હોમિયોપેથિક દવા.",
        mr: "Clematis चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Clematis",
        "commonName": "Clematis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy clematis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to clematis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of clematis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to clematis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Clematis", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/clematis",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Clematis remedy profile"]
};
