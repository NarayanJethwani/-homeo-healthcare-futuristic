...
exports.ThujaOccidentalisRemedy = void 0;
exports.ThujaOccidentalisRemedy = {
    id: "R0023",
    ...
    content: {
        ...
        "commonName": "Thuja occidentalis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy thuja occidentalis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to thuja occidentalis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of thuja occidentalis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to thuja occidentalis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
