...
exports.SymphytumRemedy = void 0;
exports.SymphytumRemedy = {
    id: "R0073",
    slug: "symphytum",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Symphytum का होम्योपैथिक विवरण.",
        gu: "Symphytum હોમિયોપેથિક દવા.",
        mr: "Symphytum चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Symphytum",
        "commonName": "Symphytum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy symphytum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to symphytum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of symphytum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to symphytum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Symphytum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/symphytum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Symphytum remedy profile"]
};
