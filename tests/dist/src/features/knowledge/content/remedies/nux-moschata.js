...
exports.NuxMoschataRemedy = void 0;
exports.NuxMoschataRemedy = {
    id: "R0056",
    slug: "nux-moschata",
    entityType: "remedy",
    ...
    content: {
        ...
        "description": "The remedy nux moschata is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to nux moschata.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of nux moschata.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to nux moschata pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
