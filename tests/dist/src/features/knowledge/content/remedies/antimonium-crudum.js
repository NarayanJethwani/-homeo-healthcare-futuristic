...
exports.AntimoniumCrudumRemedy = void 0;
exports.AntimoniumCrudumRemedy = {
    id: "R0083",
    ...
    title: {
        en: "Antimonium Crudum (Antimonium Crudum Common)",
        hi: "Antimonium Crudum",
        gu: "Antimonium Crudum",
        mr: "Antimonium Crudum",
        es: "Antimonium Crudum",
        ar: "Antimonium Crudum"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Antimonium Crudum का होम्योपैथिक विवरण.",
        gu: "Antimonium Crudum હોમિયોપેથિક દવા.",
        mr: "Antimonium Crudum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Antimonium crudum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy antimonium crudum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to antimonium crudum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of antimonium crudum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to antimonium crudum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Antimonium Crudum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/antimonium-crudum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Antimonium Crudum remedy profile"]
};
