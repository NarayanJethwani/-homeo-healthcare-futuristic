...
exports.PodophyllumRemedy = void 0;
exports.PodophyllumRemedy = {
    id: "R0060",
    slug: "podophyllum",
    entityType: "remedy",
    ...
    title: {
        en: "Podophyllum (Podophyllum Common)",
        hi: "Podophyllum",
        gu: "Podophyllum",
        mr: "Podophyllum",
        es: "Podophyllum",
    ...
    summary: {
        ...
        hi: "Podophyllum का होम्योपैथिक विवरण.",
        gu: "Podophyllum હોમિયોપેથિક દવા.",
        mr: "Podophyllum चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Podophyllum",
        "commonName": "Podophyllum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy podophyllum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to podophyllum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of podophyllum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to podophyllum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Podophyllum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/podophyllum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Podophyllum remedy profile"]
};
