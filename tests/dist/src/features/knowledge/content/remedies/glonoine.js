...
exports.GlonoineRemedy = void 0;
exports.GlonoineRemedy = {
    id: "R0044",
    slug: "glonoine",
    entityType: "remedy",
    ...
    content: {
        ...
        "description": "The remedy glonoine is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to glonoine.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of glonoine.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to glonoine pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
