...
exports.DulcamaraRemedy = void 0;
exports.DulcamaraRemedy = {
    id: "R0040",
    slug: "dulcamara",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Dulcamara का होम्योपैथिक विवरण.",
        gu: "Dulcamara હોમિયોપેથિક દવા.",
        mr: "Dulcamara चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Dulcamara",
        "commonName": "Dulcamara Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy dulcamara is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to dulcamara.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of dulcamara.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to dulcamara pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Dulcamara", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/dulcamara",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Dulcamara remedy profile"]
};
