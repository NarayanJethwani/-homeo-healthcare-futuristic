...
exports.SecaleCornutumRemedy = void 0;
exports.SecaleCornutumRemedy = {
    id: "R0067",
    ...
    title: {
        en: "Secale Cornutum (Secale Cornutum Common)",
        hi: "Secale Cornutum",
        gu: "Secale Cornutum",
        mr: "Secale Cornutum",
        es: "Secale Cornutum",
    ...
    summary: {
        ...
        hi: "Secale Cornutum का होम्योपैथिक विवरण.",
        gu: "Secale Cornutum હોમિયોપેથિક દવા.",
        mr: "Secale Cornutum चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Secale cornutum Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy secale cornutum is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to secale cornutum.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of secale cornutum.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to secale cornutum pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Secale Cornutum", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/secale-cornutum",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Secale Cornutum remedy profile"]
};
