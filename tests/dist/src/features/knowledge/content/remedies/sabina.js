...
exports.SabinaRemedy = void 0;
exports.SabinaRemedy = {
    id: "R0064",
    slug: "sabina",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Sabina का होम्योपैथिक विवरण.",
        gu: "Sabina હોમિયોપેથિક દવા.",
        mr: "Sabina चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Sabina",
        "commonName": "Sabina Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy sabina is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to sabina.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of sabina.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to sabina pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Sabina", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/sabina",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Sabina remedy profile"]
};
