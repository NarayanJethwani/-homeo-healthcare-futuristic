...
exports.IpecacuanhaRemedy = void 0;
exports.IpecacuanhaRemedy = {
    id: "R0049",
    slug: "ipecacuanha",
    entityType: "remedy",
    ...
    title: {
        en: "Ipecacuanha (Ipecacuanha Common)",
        hi: "Ipecacuanha",
        gu: "Ipecacuanha",
        mr: "Ipecacuanha",
        es: "Ipecacuanha",
    ...
    summary: {
        ...
        hi: "Ipecacuanha का होम्योपैथिक विवरण.",
        gu: "Ipecacuanha હોમિયોપેથિક દવા.",
        mr: "Ipecacuanha चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Ipecacuanha Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy ipecacuanha is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to ipecacuanha.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of ipecacuanha.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to ipecacuanha pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Ipecacuanha", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/ipecacuanha",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Ipecacuanha remedy profile"]
};
