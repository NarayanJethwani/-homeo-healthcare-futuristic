...
exports.CalcareaCarbonicaRemedy = void 0;
exports.CalcareaCarbonicaRemedy = {
    id: "R0009",
    ...
    content: {
        ...
        "commonName": "Calcarea carbonica Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy calcarea carbonica is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to calcarea carbonica.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of calcarea carbonica.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to calcarea carbonica pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
