...
exports.HamamelisRemedy = void 0;
exports.HamamelisRemedy = {
    id: "R0046",
    slug: "hamamelis",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Hamamelis का होम्योपैथिक विवरण.",
        gu: "Hamamelis હોમિયોપેથિક દવા.",
        mr: "Hamamelis चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Hamamelis",
        "commonName": "Hamamelis Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy hamamelis is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to hamamelis.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of hamamelis.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to hamamelis pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Hamamelis", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/hamamelis",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Hamamelis remedy profile"]
};
