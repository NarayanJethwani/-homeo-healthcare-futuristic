...
exports.CannabisIndicaRemedy = void 0;
exports.CannabisIndicaRemedy = {
    id: "R0095",
    ...
    title: {
        en: "Cannabis Indica (Cannabis Indica Common)",
        hi: "Cannabis Indica",
        gu: "Cannabis Indica",
        mr: "Cannabis Indica",
        es: "Cannabis Indica",
    ...
    summary: {
        ...
        hi: "Cannabis Indica का होम्योपैथिक विवरण.",
        gu: "Cannabis Indica હોમિયોપેથિક દવા.",
        mr: "Cannabis Indica चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Cannabis indica Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy cannabis indica is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to cannabis indica.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of cannabis indica.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to cannabis indica pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Cannabis Indica", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/cannabis-indica",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Cannabis Indica remedy profile"]
};
