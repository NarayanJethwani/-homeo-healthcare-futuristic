...
exports.SpigeliaRemedy = void 0;
exports.SpigeliaRemedy = {
    id: "R0068",
    slug: "spigelia",
    entityType: "remedy",
    ...
    summary: {
        ...
        hi: "Spigelia का होम्योपैथिक विवरण.",
        gu: "Spigelia હોમિયોપેથિક દવા.",
        mr: "Spigelia चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Spigelia",
        "commonName": "Spigelia Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy spigelia is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to spigelia.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of spigelia.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to spigelia pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Spigelia", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/spigelia",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Spigelia remedy profile"]
};
