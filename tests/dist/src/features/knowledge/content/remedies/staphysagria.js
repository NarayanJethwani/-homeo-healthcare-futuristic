...
exports.StaphysagriaRemedy = void 0;
exports.StaphysagriaRemedy = {
    id: "R0070",
    slug: "staphysagria",
    entityType: "remedy",
    ...
    title: {
        en: "Staphysagria (Staphysagria Common)",
        hi: "Staphysagria",
        gu: "Staphysagria",
        mr: "Staphysagria",
        es: "Staphysagria",
    ...
    summary: {
        ...
        hi: "Staphysagria का होम्योपैथिक विवरण.",
        gu: "Staphysagria હોમિયોપેથિક દવા.",
        mr: "Staphysagria चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Staphysagria Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy staphysagria is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to staphysagria.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of staphysagria.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to staphysagria pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Staphysagria", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/staphysagria",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Staphysagria remedy profile"]
};
