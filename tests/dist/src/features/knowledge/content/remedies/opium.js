...
exports.OpiumRemedy = {
    ...
    summary: {
        ...
        hi: "Opium का होम्योपैथिक विवरण.",
        gu: "Opium હોમિયોપેથિક દવા.",
        mr: "Opium चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Opium",
        "commonName": "Opium Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy opium is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to opium.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of opium.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to opium pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Opium", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/opium",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Opium remedy profile"]
};
