...
exports.CannabisSativaRemedy = void 0;
exports.CannabisSativaRemedy = {
    id: "R0096",
    ...
    title: {
        en: "Cannabis Sativa (Cannabis Sativa Common)",
        hi: "Cannabis Sativa",
        gu: "Cannabis Sativa",
        mr: "Cannabis Sativa",
        es: "Cannabis Sativa",
    ...
    summary: {
        ...
        hi: "Cannabis Sativa का होम्योपैथिक विवरण.",
        gu: "Cannabis Sativa હોમિયોપેથિક દવા.",
        mr: "Cannabis Sativa चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Cannabis sativa Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy cannabis sativa is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to cannabis sativa.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of cannabis sativa.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to cannabis sativa pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Cannabis Sativa", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/cannabis-sativa",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Cannabis Sativa remedy profile"]
};
