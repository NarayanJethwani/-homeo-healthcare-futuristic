...
exports.BerberisVulgarisRemedy = void 0;
exports.BerberisVulgarisRemedy = {
    id: "R0088",
    ...
    title: {
        en: "Berberis Vulgaris (Berberis Vulgaris Common)",
        hi: "Berberis Vulgaris",
        gu: "Berberis Vulgaris",
        mr: "Berberis Vulgaris",
        es: "Berberis Vulgaris",
        ar: "Berberis Vulgaris"
    },
    summary: {
        en: "A clinically vital homeopathic remedy with primary affinities for the Skin and Mucous Membranes and Nerves.",
        hi: "Berberis Vulgaris का होम्योपैथिक विवरण.",
        gu: "Berberis Vulgaris હોમિયોપેથિક દવા.",
        mr: "Berberis Vulgaris चे होमिओपॅथी माहिती.",
    ...
    content: {
        ...
        "commonName": "Berberis vulgaris Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy berberis vulgaris is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to berberis vulgaris.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of berberis vulgaris.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to berberis vulgaris pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Berberis Vulgaris", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/berberis-vulgaris",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Berberis Vulgaris remedy profile"]
};
