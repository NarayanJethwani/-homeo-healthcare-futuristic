...
exports.HyoscyamusRemedy = void 0;
exports.HyoscyamusRemedy = {
    id: "R0047",
    slug: "hyoscyamus",
    entityType: "remedy",
    ...
    title: {
        en: "Hyoscyamus (Hyoscyamus Common)",
        hi: "Hyoscyamus",
        gu: "Hyoscyamus",
        mr: "Hyoscyamus",
        es: "Hyoscyamus",
    ...
    summary: {
        ...
        hi: "Hyoscyamus का होम्योपैथिक विवरण.",
        gu: "Hyoscyamus હોમિયોપેથિક દવા.",
        mr: "Hyoscyamus चे होमिओपॅथी माहिती.",
    ...
    content: {
        "latinName": "Hyoscyamus",
        "commonName": "Hyoscyamus Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy hyoscyamus is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to hyoscyamus.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of hyoscyamus.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to hyoscyamus pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
    ...
    tags: ["Hyoscyamus", "Remedy", "Homeopathy"],
    canonicalUrl: "https://homeo.healthcare/knowledge/remedies/hyoscyamus",
    readingTimeMinutes: 4,
    audience: "patient",
    license: "CC BY-NC-ND 4.0",
    changeLog: ["1.0.0: Initial release of Hyoscyamus remedy profile"]
};
