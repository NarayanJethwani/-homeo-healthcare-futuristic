...
exports.IgnatiaAmaraRemedy = void 0;
exports.IgnatiaAmaraRemedy = {
    id: "R0014",
    slug: "ignatia-amara",
    entityType: "remedy",
    ...
    content: {
        ...
        "commonName": "Ignatia amara Common",
        "source": "Natural material prepared according to homeopathic pharmacopoeia standards.",
        "kingdom": "Plant",
        "remedyType": "Polychrest",
        "description": "The remedy ignatia amara is traditionally considered in constitutional clinical practice for profiles displaying marked physical and emotional characteristics. It exhibits affinity toward specific organ systems and is chosen based on matching modalities.",
        "keynotes": [
            "Modalities of aggravation and amelioration unique to ignatia amara.",
        ...
        "physicalSymptoms": [
            "Localized burning, stitching, or throbbing sensations typical of ignatia amara.",
        ...
        "constitution": "Suited to individuals showing typical reactivity corresponding to ignatia amara pathogenesis.",
        "potencies": [
            "6C",
            "30C",
            "200C",
