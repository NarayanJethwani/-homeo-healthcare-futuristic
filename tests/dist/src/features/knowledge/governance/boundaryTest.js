...
exports.verifyClinicalPlatformBoundaries = verifyClinicalPlatformBoundaries;
const robots_1 = __importDefault(require("../../../app/robots"));
const sitemap_1 = __importDefault(require("../../../app/sitemap"));
 ...
 */
async function verifyClinicalPlatformBoundaries() {
    const errors = [];
    const log = [];
    log.push("Starting clinical platform boundary audit...");
    // 1. Robots.txt audit
    try {
        const robotsRules = (0, robots_1.default)();
    ...
    // 2. Sitemap audit
    try {
        const sitemapItems = await (0, sitemap_1.default)();
