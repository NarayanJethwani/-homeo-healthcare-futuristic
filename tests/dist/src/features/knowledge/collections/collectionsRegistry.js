...
exports.CURATED_COLLECTIONS = void 0;
exports.getEntitiesForCollection = getEntitiesForCollection;
const index_1 = require("../index");
exports.CURATED_COLLECTIONS = [
    {
        id: "col-digestive",
...
function getEntitiesForCollection(collectionId) {
    const collection = exports.CURATED_COLLECTIONS.find(c => c.id === collectionId);
    if (!collection)
        return [];
