...
exports.getTodayOverviewStats = getTodayOverviewStats;
exports.getProcessedPatientQueue = getProcessedPatientQueue;
exports.getProcessedSmartAlerts = getProcessedSmartAlerts;
exports.getProcessedAiRecommendations = getProcessedAiRecommendations;
const branded_1 = require("../types/branded");
/**
 * Calculates high-level statistics for the dashboard overview panel
 */
function getTodayOverviewStats(patients = [], invoicesList = []) {
 ...
 */
function getProcessedPatientQueue(patients = []) {
    ...
    return patients.map((pat, idx) => {
        ...
        return {
            id: (0, branded_1.toPatientId)(pat.id),
            name: pat.name,
            age: pat.age,
            gender: pat.gender || "M",
 ...
 */
function getProcessedSmartAlerts(patients = []) {
    const alerts = [];
 ...
 */
function getProcessedAiRecommendations(patients = []) {
