...
exports.compareBenchmarkRuns = compareBenchmarkRuns;
function rankAndScore(run, caseId, remedyId) {
...
function compareBenchmarkRuns(previous, current, allowedScoreDelta = 0.01) {
    const differences = [];
