...
exports.parseLabReport = parseLabReport;
function parseLabReport(fileName, rawText) {
    ...
    const extractNumericValue = (regexes, defaultValue, defaultStatus, normalMin, normalMax, unit) => {
