...
exports.getAssessmentsByCategory = exports.ASSESSMENT_PROFILES = exports.ASSESSMENT_CATEGORIES = void 0;
exports.ASSESSMENT_CATEGORIES = [
...
const getAssessmentsByCategory = (catId) => {
    return exports.ASSESSMENT_PROFILES.filter(p => p.category === catId);
};
exports.getAssessmentsByCategory = getAssessmentsByCategory;
