...
exports.FirestoreRemedyBridge = exports.MASTER_REMEDY_DB = void 0;
const remedyDataPack_json_1 = __importDefault(require("./remedyDataPack.json"));
const CORE_16_REMEDIES = [
    {
        id: "rem_sulphur",
        identity: {
            name: "Sulphur",
...
function inflateCompressedRemedy(c) {
    ...
    const organAffinities = c.organs.map((o) => ({
        organ: o.organ,
        rating: o.rating,
    ...
    return {
        ...
        clinicalKnowledge: {
            ...
            characteristicConditions: clinicalConditions.map((cc) => cc.condition),
...
exports.MASTER_REMEDY_DB = [
    ...CORE_16_REMEDIES,
    ...remedyDataPack_json_1.default.map(inflateCompressedRemedy)
];
class FirestoreRemedyBridge {
...
exports.FirestoreRemedyBridge = FirestoreRemedyBridge;
