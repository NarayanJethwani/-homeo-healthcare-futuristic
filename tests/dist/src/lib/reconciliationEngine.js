...
exports.AUTHOR_WEIGHTS = void 0;
exports.getGradeWeight = getGradeWeight;
exports.reconcileSymptom = reconcileSymptom;
exports.generateUnifiedRemedyProfile = generateUnifiedRemedyProfile;
exports.AUTHOR_WEIGHTS = {
    "Kent": 1.0,
    "Hering": 1.0,
    "Boericke": 0.9,
    "Allen": 0.9,
 ...
 */
function reconcileSymptom(remedyId, symptomKey, sources) {
    if (sources.length === 0) {
        return {
            symptomKey,
            reconciledGrade: 1,
    ...
    const gradesCollected = [];
    sources.forEach(src => {
        const sWeight = exports.AUTHOR_WEIGHTS[src.author] || 0.5;
 ...
 */
function generateUnifiedRemedyProfile(remedyId) {
    // Mock data representing a raw text ingestion stream for Sulphur
    const sulphurRawSymptoms = {
        "burning_soles": [
