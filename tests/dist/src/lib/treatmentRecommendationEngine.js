...
exports.getTreatmentRecommendation = getTreatmentRecommendation;
/**
 ...
 */
function getTreatmentRecommendation(selectedPlan, conditionCount, duration, billingFrequency, selectedComplexity) {
    let recommendedProgram = "Standard Chronic Care";
    let complexity = "Standard";
    let confidence = "High";
    let followUpFrequency = "Bi-weekly";
    let reasons = [];
    ...
    if (selectedComplexity) {
        if (selectedComplexity === "Low" || selectedComplexity === "Routine")
            complexity = "Routine";
        else if (selectedComplexity === "Moderate" || selectedComplexity === "Standard")
            complexity = "Standard";
        else if (selectedComplexity === "Moderate–High" || selectedComplexity === "Enhanced")
            complexity = "Enhanced";
        else if (selectedComplexity === "High" || selectedComplexity === "Advanced")
            complexity = "Advanced";
        else if (selectedComplexity === "Comprehensive")
            complexity = "Comprehensive";
        else if (selectedComplexity === "Intensive")
            complexity = "Intensive";
    }
    return {
        recommendedProgram,
