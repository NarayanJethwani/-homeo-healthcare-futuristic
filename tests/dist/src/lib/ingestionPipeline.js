...
exports.runIngestionSimulation = exports.RUBRIC_SYNONYMS = exports.REMEDY_ABBREVIATIONS = exports.INGESTION_SOURCES = void 0;
...
const runIngestionSimulation = (sourceId) => {
    const source = exports.INGESTION_SOURCES.find(s => s.id === sourceId) || exports.INGESTION_SOURCES[0];
    const logs = [];
    let parsedRecords = 0;
...
exports.runIngestionSimulation = runIngestionSimulation;
