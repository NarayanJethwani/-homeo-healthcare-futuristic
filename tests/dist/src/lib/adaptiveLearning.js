...
exports.updateStudentMastery = updateStudentMastery;
exports.initDefaultMastery = initDefaultMastery;
exports.initDefaultSM2 = initDefaultSM2;
/**
 ...
 */
function updateStudentMastery(currentMastery, quizScore, totalQuestions, missedSymptoms) {
 ...
 */
function initDefaultMastery(remedyId) {
    return {
        remedyId,
        masteryScore: 0,
        retentionRate: 50,
 ...
 */
function initDefaultSM2(cardId) {
    return {
        cardId,
        repetitions: 0,
        interval: 0,
