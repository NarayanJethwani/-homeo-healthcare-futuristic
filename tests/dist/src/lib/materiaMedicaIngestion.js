...
exports.simulateMateriaMedicaIngestion = exports.CLASSICAL_SOURCES = void 0;
const materiaMedicaDb_1 = require("./materiaMedicaDb");
exports.CLASSICAL_SOURCES = [
...
const simulateMateriaMedicaIngestion = (sourceId) => {
    const source = exports.CLASSICAL_SOURCES.find(s => s.id === sourceId) || exports.CLASSICAL_SOURCES[0];
    const logs = [];
    const snippets = [];
    const addLog = (level, stage, message) => {
    ...
    const remediesMapped = Math.min(monographsDetected, materiaMedicaDb_1.MASTER_REMEDY_DB.length + Math.floor(seed * 0.5));
...
exports.simulateMateriaMedicaIngestion = simulateMateriaMedicaIngestion;
