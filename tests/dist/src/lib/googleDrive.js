...
exports.createDoctorWorkspace = createDoctorWorkspace;
exports.addCalendarEvent = addCalendarEvent;
exports.createPatientFolder = createPatientFolder;
exports.createPatientClinicalSheet = createPatientClinicalSheet;
exports.appendPatientToMasterRecord = appendPatientToMasterRecord;
exports.appendAiReportToClinicalSheet = appendAiReportToClinicalSheet;
exports.syncAttachmentsToClinicalSheet = syncAttachmentsToClinicalSheet;
exports.syncConfigDbToClinicalSheet = syncConfigDbToClinicalSheet;
exports.extractSpreadsheetId = extractSpreadsheetId;
exports.getPatientRowsFromSheet = getPatientRowsFromSheet;
exports.getServiceAccountEmail = getServiceAccountEmail;
exports.isGoogleDriveFolder = isGoogleDriveFolder;
exports.extractFolderId = extractFolderId;
exports.listFilesInFolder = listFilesInFolder;
exports.createInvoiceSheet = createInvoiceSheet;
exports.appendInvoiceToClinicalSheet = appendInvoiceToClinicalSheet;
exports.downloadFileFromGoogleDrive = downloadFileFromGoogleDrive;
exports.getColumnLetter = getColumnLetter;
exports.getRepertoryFormattingRequests = getRepertoryFormattingRequests;
exports.syncRepertoryToClinicalSheet = syncRepertoryToClinicalSheet;
exports.uploadFileToFolder = uploadFileToFolder;
const googleapis_1 = require("googleapis");
function getDoctorEmails() {
 ...
 */
async function createDoctorWorkspace(doctorName, doctorEmail) {
    ...
    const driveFolderUrl = folderRes.data.webViewLink ||
    ...
    if (driveFolderId && doctorEmail) {
        await drive.permissions
            ...
            .catch((err) => console.warn(`Could not share Drive folder with ${doctorEmail}:`, err));
    }
    ...
    try {
        ...
        if (masterSheetId && doctorEmail) {
            await drive.permissions
                ...
                .catch((err) => console.warn(`Could not share Master Sheet with ${doctorEmail}:`, err));
        }
    }
    catch (sheetErr) {
 ...
 */
async function createPatientFolder(data) {
    const auth = getGoogleAuth();
    if (!auth) {
    ...
    try {
        ...
        if (folderId) {
            try {
                ...
                const sharePromises = emails.map(email => drive.permissions.create({
                    fileId: folderId,
                    sendNotificationEmail: false,
                    supportsAllDrives: true,
                    requestBody: {
 ...
 */
async function createPatientClinicalSheet(folderId, data) {
    const auth = getGoogleAuth();
    if (!auth) {
    ...
    try {
        ...
        if (newSheetId) {
            ...
            if (TEMPLATE_SHEET_ID) {
                ...
                caseTakingValues[2][0] = "Patient ID";
                caseTakingValues[2][1] = data.id;
                caseTakingValues[3][0] = "Full Patient Name";
                caseTakingValues[3][1] = data.name;
                caseTakingValues[4][0] = "Age / Gender";
                caseTakingValues[4][1] = `${data.age} / ${data.gender}`;
                caseTakingValues[5][0] = "Contact Phone";
                caseTakingValues[5][1] = data.phone;
                caseTakingValues[6][0] = "Email Address";
                caseTakingValues[6][1] = data.email || "N/A";
                caseTakingValues[7][0] = "Address / Location";
                caseTakingValues[7][1] = locationVal;
                caseTakingValues[8][0] = "Register Date";
                caseTakingValues[8][1] = today;
                // Section 2 Chief Complaints
                caseTakingValues[9][0] = "SECTION 2 – CHIEF COMPLAINT ANALYSIS";
                caseTakingValues[10][0] = "Primary Case Complaint";
                caseTakingValues[10][1] = data.complaint;
                caseTakingValues[11][0] = "Duration";
                caseTakingValues[11][1] = data.durationText || "Chronic";
                caseTakingValues[12][0] = "Onset (Sudden / Gradual)";
                caseTakingValues[12][1] = "Gradual";
                caseTakingValues[13][0] = "Complaint Severity (1-10)";
                caseTakingValues[13][1] = "8";
                // Section 3 Presenting Symptoms
                caseTakingValues[14][0] = "SECTION 3 – PRESENTING SYMPTOMS (REPERTORY TOTALITY)";
                caseTakingValues[15][0] = "Location / Extension";
                caseTakingValues[15][1] = "";
                caseTakingValues[16][0] = "Sensation / Pain Character";
                caseTakingValues[16][1] = "";
                caseTakingValues[17][0] = "Modalities Better (Amelioration)";
                caseTakingValues[17][1] = "";
                caseTakingValues[18][0] = "Modalities Worse (Aggravation)";
                caseTakingValues[18][1] = "";
                caseTakingValues[19][0] = "Concomitants";
                caseTakingValues[19][1] = "";
                caseTakingValues[20][0] = "Etiology / Causes";
                caseTakingValues[20][1] = "";
                caseTakingValues[21][0] = "Maintaining Causes";
                caseTakingValues[21][1] = "";
                // Section 4 Mental Generals
                caseTakingValues[22][0] = "SECTION 4 – MENTAL GENERALS";
                caseTakingValues[23][0] = "Temperament";
                caseTakingValues[23][1] = "";
                caseTakingValues[24][0] = "Fears & Phobias";
                caseTakingValues[24][1] = "";
                caseTakingValues[25][0] = "Anxiety States";
                caseTakingValues[25][1] = "";
                caseTakingValues[26][0] = "Anger & Reactions";
                caseTakingValues[26][1] = "";
                caseTakingValues[27][0] = "Grief / Suppressions";
                caseTakingValues[27][1] = "";
                caseTakingValues[28][0] = "Personality Traits / Attributes";
                caseTakingValues[28][1] = "";
                // Section 5 Physical Generals
                caseTakingValues[29][0] = "SECTION 5 – PHYSICAL GENERALS";
                caseTakingValues[30][0] = "Appetite / Hunger";
                caseTakingValues[30][1] = "";
                caseTakingValues[31][0] = "Thirst Quality";
                caseTakingValues[31][1] = "";
                caseTakingValues[32][0] = "Food Desires";
                caseTakingValues[32][1] = "";
                caseTakingValues[33][0] = "Food Aversions";
                caseTakingValues[33][1] = "";
                caseTakingValues[34][0] = "Thermal State (Chilly / Hot)";
                caseTakingValues[34][1] = "";
                caseTakingValues[35][0] = "Sleep Cycles & Dreams";
                caseTakingValues[35][1] = "";
                // Section 9 Clinical Diagnosis
                caseTakingValues[36][0] = "SECTION 9 – CLINICAL DIAGNOSIS";
                caseTakingValues[37][0] = "Clinical Diagnosis";
                caseTakingValues[37][1] = "";
                caseTakingValues[38][0] = "Case Complexity";
                caseTakingValues[38][1] = "";
                // Section 10 Miasmatic Assessment
                caseTakingValues[39][0] = "SECTION 10 – MIASMATIC ASSESSMENT (FORMULA DRIVEN)";
                caseTakingValues[40][0] = "Psora Miasm Score";
                caseTakingValues[40][1] = "=COUNTIF(B3:B39, \"*[Psora]*\")";
                caseTakingValues[41][0] = "Sycosis Miasm Score";
                caseTakingValues[41][1] = "=COUNTIF(B3:B39, \"*[Sycosis]*\")";
                caseTakingValues[42][0] = "Syphilis Miasm Score";
                caseTakingValues[42][1] = "=COUNTIF(B3:B39, \"*[Syphilis]*\")";
                caseTakingValues[43][0] = "Tubercular Miasm Score";
                caseTakingValues[43][1] = "=COUNTIF(B3:B39, \"*[Tubercular]*\")";
                caseTakingValues[44][0] = "Cancerinic Miasm Score";
                caseTakingValues[44][1] = "=COUNTIF(B3:B39, \"*[Cancerinic]*\")";
                // Section 12 Prescription
                caseTakingValues[45][0] = "SECTION 12 – CURRENT PRESCRIPTION & ADVICE";
                caseTakingValues[46][0] = "Remedy Name";
                caseTakingValues[46][1] = "";
                caseTakingValues[47][0] = "Potency / Scale";
                caseTakingValues[47][1] = "";
                caseTakingValues[48][0] = "Dosage & Frequency";
                caseTakingValues[48][1] = "";
                caseTakingValues[49][0] = "Duration";
                caseTakingValues[49][1] = "";
                caseTakingValues[50][0] = "Dietary & lifestyle advice";
                caseTakingValues[50][1] = "";
                // Section 13 AI Diagnostics (to be populated by portal)
                caseTakingValues[51][0] = "SECTION 13 – AI CLINICAL SYNTHESIS VERDICT";
                caseTakingValues[52][0] = "AI Analysis Engine";
                caseTakingValues[52][1] = "Gemini 3.5 Clinical Synthesis";
                caseTakingValues[53][0] = "Analysis Timestamp";
                caseTakingValues[53][1] = "";
                caseTakingValues[54][0] = "AI Constitutional Justification";
                caseTakingValues[54][1] = "";
...
async function appendPatientToMasterRecord(data, folderUrl, sheetUrl, assignedDoctorName) {
    const auth = getGoogleAuth();
 ...
 */
async function appendAiReportToClinicalSheet(sheetId, aiReport) {
    const auth = getGoogleAuth();
    if (!auth) {
 ...
 */
async function syncAttachmentsToClinicalSheet(sheetId, attachments) {
    const auth = getGoogleAuth();
    if (!auth) {
 ...
 */
async function syncConfigDbToClinicalSheet(sheetId, configDb) {
    const auth = getGoogleAuth();
    if (!auth) {
    ...
    const sheets = googleapis_1.google.sheets({ version: "v4", auth });
    try {
        const maxRows = Math.max(configDb.remedies.length, configDb.potencies.length, configDb.miasms.length, configDb.locations.length, (configDb.doctors || []).length, configDb.packages.length);
        const rows = [];
 ...
 */
async function getPatientRowsFromSheet(spreadsheetId) {
    const auth = getGoogleAuth();
 ...
 */
function isGoogleDriveFolder(urlOrId) {
    if (!urlOrId)
        return false;
 ...
 */
async function createInvoiceSheet(folderId, data) {
    const auth = getGoogleAuth();
    if (!auth) {
    ...
    try {
        ...
        if (!sheetId)
            throw new Error("Failed to create spreadsheet for invoice");
        // 2. Generate values
 ...
 */
async function appendInvoiceToClinicalSheet(sheetId, data) {
    const auth = getGoogleAuth();
    if (!auth) {
 ...
 */
async function downloadFileFromGoogleDrive(fileId, destPath) {
    const auth = getGoogleAuth();
    if (!auth) {
 ...
 */
function getRepertoryFormattingRequests(repertoryId, N, existingRules = [], remediesCount = 11) {
    const requests = [];
 ...
 */
async function syncRepertoryToClinicalSheet(sheetId, rubrics, remedies = ["Nux-v", "Lyc", "Ars", "Puls", "Sulph", "Rhus-t", "Calc", "Sil", "Nat-m", "Ign", "Sep"]) {
    const auth = getGoogleAuth();
    if (!auth) {
 ...
 */
async function uploadFileToFolder(folderId, fileName, mimeType, fileData) {
    const auth = getGoogleAuth();
    if (!auth) {
