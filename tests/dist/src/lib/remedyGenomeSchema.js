...
exports.GENOME_REMEDY_DB = void 0;
const remedyDataPack_json_1 = __importDefault(require("./remedyDataPack.json"));
function inflateGenome(c) {
    ...
    const brain = c.organs.find((o) => o.organ === "Brain")?.rating * 10 || 50;
    const throat = c.organs.find((o) => o.organ === "Throat" || o.organ === "Mouth/Throat" || o.organ === "Mouth")?.rating * 10 || 50;
    const skin = c.organs.find((o) => o.organ === "Skin")?.rating * 10 || 50;
    const digestive = c.organs.find((o) => o.organ === "Digestive" || o.organ === "Gastrointestinal")?.rating * 10 || 50;
    const nervous = c.organs.find((o) => o.organ === "Nervous System")?.rating * 10 || 50;
    const musculoskeletal = c.organs.find((o) => o.organ === "Musculoskeletal")?.rating * 10 || 50;
    const genome = {
...
exports.GENOME_REMEDY_DB = [
    ...CORE_16_GENOMES,
    ...remedyDataPack_json_1.default.map(inflateGenome)
];
